...
// Real prerendered AEO surfaces — NOT intentional door hops.
// 2026-08-28: /pricing → /os?lobby=assess&task=pricing-overview and
// /certification → /honesty/ are Cloudflare Functions door hops (measurement,
// not certification; prices live in Council OS Assess). Gating those paths
// against self-canonical HTML false-fails every master push. Probe the
// destinations that still ship distinct prerendered HTML instead.
