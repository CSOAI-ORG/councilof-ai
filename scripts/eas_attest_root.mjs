...
// Dependencies are deliberately loaded only after the no-key state has been
// persisted. The workflow treats the SDK install as best-effort; a static import
// made Node fail during module loading and prevented the honest NOT_YET record
// from being written on runners where that install was unavailable.
