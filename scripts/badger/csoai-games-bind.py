...
GAMES = [
    {
        ...
        "description": "Agent clans deliberating in an open world. Each turn emits a signed card.",
        "status": "LIVE",
        "axis_feeds": ["governance", "safety"],
        "multiplayer": True,
    ...
    },
    {
        ...
        "description": "Multiple agents deliberate a question, emit signed verdicts.",
        "status": "LIVE",
        "axis_feeds": ["governance", "safety", "reasoning"],
        "multiplayer": True,
        "players": "2-8 players",
        "agui": True,
        "a2ui": True,
    ...
    },
    {
        ...
        "description": "Two AI models compete on a benchmark. Emits a signed winner card.",
        "status": "LIVE",
        "axis_feeds": ["capability", "performance", "conduct"],
        "multiplayer": True,
    ...
    },
    {
        ...
        "description": "Two AI models are scored on GSPC axes. Winner takes the signed leader card.",
        "status": "LIVE",
        "axis_feeds": ["governance", "safety", "performance", "conduct", "capability"],
        "multiplayer": True,
        "players": "spectator + challenger",
        "agui": True,
        "a2ui": True,
    ...
    },
    {
        ...
        "description": "Multi-step governance scenarios. Each step emits a signed card.",
        "status": "LIVE",
        "axis_feeds": ["governance", "safety", "compliance"],
        "multiplayer": False,
    ...
    },
    {
        ...
        "description": "Guided lessons on AI governance. Each lesson emits a completion card.",
        "status": "LIVE",
        "axis_feeds": ["governance", "safety"],
        "multiplayer": False,
        "players": "single player",
    ...
    },
    {
        ...
        "description": "Plan-Do-Check-Act governance cycles. Emits signed cycle cards.",
        "status": "LIVE",
        "axis_feeds": ["governance", "compliance"],
        "multiplayer": True,
        "players": "2-4 players",
        "agui": True,
        "a2ui": True,
    ...
    },
    {
        ...
        "description": "Citizens deliberate policy questions. Emits signed policy cards.",
        "status": "STAGED",
        "axis_feeds": ["governance", "safety", "compliance", "conduct"],
        "multiplayer": True,
...
def build_game_discovery(game: dict) -> dict:
    return {
        ...
        "links": {
            ...
            "x402": f"https://councilof.ai/api/x402?sku={game['x402_sku']}",
            "live_board": "https://councilof.ai/api/gspc",
            "verify": "https://councilof.ai/gspc-verify",
        },
        "x402": {
            "sku": game["x402_sku"],
            "price_usdc": game["x402_price"],
        },
        "notes": [
...
def build_game_agent(game: dict) -> dict:
    return {
        ...
        "capabilities": {
            ...
            "attestation": "Every turn emits a signed card",
...
def build_game_interop(game: dict) -> dict:
    return {
        ...
        "engine": game["engine"],
        "as_of": now(),
        "x402_sku": game["x402_sku"],
        "x402_price_usdc": game["x402_price"],
        "protocols": ["a2a", "mcp", "x402", "ag-ui", "a2-ui", "websocket"],
        "anchor_chain": ["opentimestamps", "sigstore_rekor", "eas_base"],
        "capabilities": [
