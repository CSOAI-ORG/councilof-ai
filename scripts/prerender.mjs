...
function discover() {
  ...
  const MUST = [
    ...
    // Dead homepage blog slugs 308 to /blog/ (generate-redirects + functions/blog).
    // Do not snapshot them: a prerendered index.html shadows the 308 and brand-gate
    // rejected choosing-ai-compliance-vendor for leftover competitor GRC prices.
    "/evidence-rail",
    "/datasets",
  ];
  ...
  // Dead blog slugs already 308 to /blog/. Heuristic discovery still finds the
  // literals in the bundle; snapshotting them shadows the 308 and brand-gate
  // rejects leftover competitor GRC prices ("£100,000 per year").
