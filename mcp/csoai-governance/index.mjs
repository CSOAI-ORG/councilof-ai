...
const TOOLS = [
  ...
  {
    name: "csoai_catalog",
    description: "Search the CSOAI catalog of 377 governed tools / MCPs (framework-compliance, cyber, evidence, identity, and more). Returns matching governed tools with their cluster and install hint.",
    inputSchema: {
      type: "object",
