...
const TEAM = {
  ...
  specialists: [
      { id: "gov", class: "axis", model: "qwen3:8b", role: "governance specialist", signal: "/register/register-index" },
      { id: "safety", class: "axis", model: "council-oowm:latest", role: "safety/containment specialist", signal: "/jail" },
      { id: "knowledge", class: "axis", model: "phi4:14b", role: "factual/general knowledge specialist", signal: "/register/model-measurements-index" },
      { id: "prv", class: "axis", model: "mistral:7b", role: "privacy specialist", signal: "/register/register-index" },
      { id: "swarm", class: "axis", model: "qwen2.5:7b", role: "swarm/coordination specialist", signal: "/cross" },
      { id: "provenance", class: "axis", model: "gemma3:12b", role: "provenance/source-attribution specialist", signal: "/register/boards-pod-index" },
      { id: "conformance", class: "axis", model: "qwen3:4b", role: "protocol-conformance specialist", signal: "/register/x402-a2a-conformance" },
      { id: "care", class: "axis", model: "qwen2.5:7b", role: "care/values-alignment specialist", signal: "/compliance" },
      { id: "regulator-uk", class: "regulator", model: "mistral:7b", role: "UK regulator specialist", signal: "/register/register-index" },
      { id: "regulator-eu", class: "regulator", model: "qwen3:8b", role: "EU AI-Act regulator specialist", signal: "/register/register-index" },
      { id: "industry-finance", class: "industry", model: "phi4:14b", role: "financial-AI specialist", signal: "/register/financial-ai-index" },
      { id: "industry-gaming", class: "industry", model: "qwen3:4b", role: "game/arena measurement specialist", signal: "/games/gspc" },
      { id: "product-payments", class: "product", model: "qwen2.5:7b", role: "x402/payments specialist", signal: "/register/x402-a2a-conformance" },
  ],
  metrics: {
