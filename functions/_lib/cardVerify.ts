...
const FAMILY_LABEL: Record<Family, string> = {
  // No count here. The published set grows; a number typed into a label is a
  // count this file cannot derive, and it was already wrong (150 -> 313) by the
  // time anyone read it. /signed/chain.json is the authority on how many exist.
  "gspc.measurement-card": "the signed board cards",
