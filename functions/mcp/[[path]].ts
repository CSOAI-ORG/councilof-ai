      ...
      return Response.json(
        {
          ...
          paid_tools: {
            ...
            how: "tools/call without x_payment returns the route's x402 402 challenge (accepts[], PAYMENT-REQUIRED) as structuredContent. Pay from your wallet and call again with x_payment. That challenge is not settlement, delivery or revenue. Amounts live only inside a 402. HTTP paid doors that are not MCP tool names (including /api/evidence-bundle and /api/proof?bundle=1) are listed at /api/x402 on the same rail.",
