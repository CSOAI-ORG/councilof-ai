...
const META: Record<string, { t: string; d: string }> = {
  "/": { t: "CSOAI — AI governance, cybersecurity & safety", d: "Signed to Layer 0 · deterministic measurement harnesses · open source · aligned to published frameworks" },
  "/os": { t: "The Council OS — governed AI tools", d: "An operating system for AI governance, not a dashboard. Run live governed tools, sealed to Layer 0." },
  ...
  "/crosswalk": { t: "The AI governance framework crosswalk", d: "Published frameworks mapped to a shared control set. Map once, evidence everywhere. Determination stays with authorities." },
  "/east-west": { t: "East-West — one signed measurement, every regime mapped", d: "Cross-jurisdiction governance measurement. Scores free to verify; regulator rails free forever. Not certification." },
  "/challenge": { t: "Challenge a measurement — East-West redress", d: "Contest a signed cross-border measurement. Disputes answered with re-measurement, never assertions." },
...
export default async function middleware(req: Request): Promise<Response | undefined> {
  try {
    ...
    const desc = m ? m.d : "AI governance, cybersecurity & safety — signed to Layer 0 · open source · aligned to published frameworks";
