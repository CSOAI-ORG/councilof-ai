...
const META: Record<string, { t: string; d: string }> = {
  ...
  "/crosswalk": { t: "The AI governance framework crosswalk", d: "Published frameworks mapped to a shared control set. Comply once, evidence everywhere. Open and citable." },
