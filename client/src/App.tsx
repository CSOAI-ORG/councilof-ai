...
const MCPScoreboard = lazy(() => import("./pages/MCPScoreboard"));
...
const ROUTE_TITLES: Record<string, string> = {
  ...
  "/packs/mcp-scoreboard": "MCP scoreboard — model conformance & tool-poisoning safety | CSOAI",
        ...
        <AuthProvider>
          ...
          <Route path="/cobol" component={LegacyBridge} />
            ...
            <Route path="/sovereign-town">{() => <Redirect to="/sov-space?view=towns" />}</Route>
                  ...
                  <Route path="/packs/mcp-scoreboard" component={MCPScoreboard} />
