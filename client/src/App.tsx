 ...
 *  stays inside one workspace. `embed=1` is preserved and the Dashboard renders the same
 *  workspace without its outer navigation chrome; there is no second embedded Council OS. */
function OsRoute() {
...
const AnswerPage = lazy(() =>
  import("./pages/Answers").then((m) => ({ default: m.AnswerPage })),
);
...
const AustraliaAIGovernanceCompliance = lazy(
  () => import("./pages/AustraliaAIGovernanceCompliance"),
);
const CanadaAIActCompliance = lazy(
  () => import("./pages/CanadaAIActCompliance"),
);
...
const CouncilLicensingLanding = lazy(
  () => import("./pages/CouncilLicensingLanding"),
);
...
const AustraliaAIGovernance = lazy(
  () => import("./pages/AustraliaAIGovernance"),
);
const CanadaAIAct = lazy(() => import("./pages/CanadaAIAct"));
const UKAIBill = lazy(() => import("./pages/UKAIBill"));
const GlobalAISafetyInitiative = lazy(
  () => import("./pages/GlobalAISafetyInitiative"),
);
...
const CertificationHowItWorks = lazy(
  () => import("./pages/CertificationHowItWorks"),
);
...
const WatchdogHelpProtectHumanity = lazy(
  () => import("./pages/WatchdogHelpProtectHumanity"),
);
const WatchdogIncidentReport = lazy(
  () => import("./pages/WatchdogIncidentReport"),
);
...
const AgentCouncilFeature = lazy(
  () => import("./pages/features/AgentCouncilFeature"),
);
const PDCAFrameworkFeature = lazy(
  () => import("./pages/features/PDCAFrameworkFeature"),
);
const TrainingCertificationFeature = lazy(
  () => import("./pages/features/TrainingCertificationFeature"),
);
const WatchdogJobsFeature = lazy(
  () => import("./pages/features/WatchdogJobsFeature"),
);
...
const FoundingCouncilAgreement = lazy(
  () => import("./pages/legal/FoundingCouncilAgreement"),
);
const LicensingAgreement = lazy(
  () => import("./pages/legal/LicensingAgreement"),
);
...
const DataProcessingAgreement = lazy(
  () => import("./pages/legal/DataProcessingAgreement"),
);
const CookiePolicy = lazy(() => import("./pages/legal/CookiePolicy"));
const ServiceLevelAgreement = lazy(
  () => import("./pages/legal/ServiceLevelAgreement"),
);
const Council = lazy(() => import("./pages/Council"));
const GlobalRegulationTracker = lazy(
  () => import("./pages/GlobalRegulationTracker"),
);
...
const ComplianceCommandCenter = lazy(
  () => import("./pages/ComplianceCommandCenter"),
);
...
const VulnerabilityDisclosure = lazy(
  () => import("./pages/VulnerabilityDisclosure"),
);
...
const DistributionIntegrity = lazy(
  () => import("./pages/DistributionIntegrity"),
);
...
const RegulatorFindingsDetail = lazy(
  () => import("./pages/RegulatorFindingsDetail"),
);
...
const ROUTE_TITLES: Record<string, string> = {
  ...
  "/licensing-agreement":
    "Measurement licence — evidence and data | Council of AI",
  "/licence-manifest":
    "Licence manifest — request evidence, not a rank | Council of AI",
  ...
  "/certification":
    "Measurement credential — how CSOAI attestation works | CSOAI",
  ...
  "/leaderboard":
    "The AI Governance Leaderboard — sorted by the axis you care about | Council of AI",
  ...
  "/findings":
    "Regulation Findings — every signed finding, mapped to its regulator | CSOAI",
  ...
  "/board":
    "The measurement board — every set, what it measures, what it does not | Council of AI",
  ...
  "/financial-axes":
    "Financial axis — the financial half of the GSPC board | Council of AI",
  ...
  "/xrpl-attest":
    "XRPL public-root catalogue — unsigned leaves; /api/xrpl reader | Council of AI",
  "/claims-register":
    "Claims register — every public claim, its evidence, its status | CSOAI",
  "/distribution-integrity":
    "Distribution integrity — represented is not distributed | Council of AI",
  ...
  "/transparency-cop":
    "Transparency Code — detection/verify tool, C2PA planned | Council of AI",
  ...
  "/east-west":
    "East-West — one signed measurement, every regime mapped | Council of AI",
  ...
  "/accountability-loop":
    "The accountability loop — from a public report to a complaint a regulator can open | Council of AI",
  "/where-the-record-lives":
    "Where the record lives — mirrored, not indestructible | Council of AI",
  "/statute-to-predicate":
    "From statute to predicate — how a law becomes a test | Council of AI",
  ...
  "/benchmark-quality":
    "Benchmark-quality register — deterministic predicates on third-party AI benchmarks | Council of AI",
  "/provenance-finding": "Provenance Finding | CSOAI",
  "/learn": "Learn | CSOAI",
  "/article-50": "Article 50 | CSOAI",
  "/packs/eu-article-50":
    "EU Article 50 evidence pack — signed C2PA durability | CSOAI",
  "/gpai-evidence":
    "GPAI Evidence Pack — independent evidence for the AI Office | CSOAI",
  "/cra-readiness":
    "CRA Readiness Kit — the 24h/72h/14-day runbook, signed | CSOAI",
  ...
  "/demo": "Demo | CSOAI",
  "/assess":
    "Get measured — paid measurement; booking not live | Council of AI",
          ...
          <WidgetLayout>
            ...
            >
              <Switch>
                ...
                <Route
                  path="/widget/course/:courseId"
                  component={WidgetCoursePlayer}
                />
                <Route>
...
function App() {
  ...
  // Every former workspace-shaped surface is now an alias into one dashboard.
  if (
    [
      "/ag-ui",
      "/chat",
  ...
  if (
    ...
    return <Redirect to="/dashboard?tab=space" />;
  }
  if (
    ...
    return <Redirect to="/dashboard?tab=fabric" />;
  }
  if (["/assess", "/assessment", "/readiness-assessment"].includes(path)) {
    return <Redirect to="/dashboard?tab=measured" />;
  }
  if (["/home-v2", "/old-home"].includes(path)) return <Redirect to="/" />;
  return (
    <ErrorBoundary>
      <ThemeProvider defaultTheme="light">
        <AuthProvider>
                ...
                >
                  ...
                  >
                    <Switch>
                      ...
                      <Route path="/home-v2">{() => <Redirect to="/" />}</Route>
                      <Route path="/home-v3">
                        {() => <Redirect to="/dashboard?tab=home" />}
                      </Route>
                      <Route path="/motion-lab" component={MotionLab} />
                      <Route
                        path="/remediation-partners"
                        component={RemediationPartners}
                      />
                      ...
                      <Route
                        ...
                        component={CouncilModelCard}
                      />
                      <Route
                        path="/council-system-card"
                        component={CouncilSystemCard}
                      />
                      <Route
                        path="/workbench-paper"
                        component={CouncilWhitepaper}
                      />
                      <Route path="/sov3-model-card">
                        {() => <Redirect to="/council-model-card" />}
                      </Route>
                      <Route path="/sov3-system-card">
                        {() => <Redirect to="/council-system-card" />}
                      </Route>
                      <Route path="/sov3-whitepaper">
                        {() => <Redirect to="/workbench-paper" />}
                      </Route>
                      <Route
                        path="/research-transparency"
                        component={ResearchTransparency}
                      />
                      <Route
                        path="/provenance-finding"
                        component={ProvenanceFinding}
                      />
                      <Route
                      ...
                      <Route path="/about-ceasai">
                        {() => <Redirect to="/about-credential" />}
                      </Route>
                      <Route path="/accessibility" component={Accessibility} />
                      <Route path="/analytics" component={AnalyticsDashboard} />
                      <Route path="/byzantine-consensus">
                        {() => <Redirect to="/council" />}
                      </Route>
                      <Route
                        path="/credential-training"
                        component={CEASAITraining}
                      />
                      <Route path="/ceasai-training">
                        {() => <Redirect to="/credential-training" />}
                      </Route>
                      <Route
                      ...
                      <Route
                        ...
                        component={AustraliaAIGovernanceCompliance}
                      />
                      <Route
                        path="/compliance/canada-ai-act"
                        component={CanadaAIActCompliance}
                      />
                      <Route
                        path="/compliance/eu-ai-act"
                        component={EUAIActCompliance}
                      />
                      <Route
                        path="/compliance/nist-ai-rmf"
                        component={NISTAIRMFCompliance}
                      />
                      <Route
                        path="/compliance/tc260"
                        component={TC260Compliance}
                      />
                      <Route
                        path="/compliance/uk-ai-bill"
                        component={UKAIBillCompliance}
                      />
                      <Route
                        path="/conformity-route"
                        component={ConformityRoute}
                      />
                      <Route path="/contact" component={Contact} />
                      <Route path="/council-detail" component={CouncilDetail} />
                      <Route
                        path="/council-licensing"
                        component={CouncilLicensingLanding}
                      />
                      ...
                      <Route
                        ...
                        component={GlobalAISafetyInitiative}
                      />
                      <Route path="/govbench" component={GovBench} />
                      <Route path="/drift-audit" component={DriftProduct} />
                      <Route path="/sov-town-lab">
                        {() => <Redirect to="/gspc-arena?view=towns" />}
                      </Route>
                      <Route
                        path="/government-links"
                        component={GovernmentLinks}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        component={CertificationHowItWorks}
                      />
                      <Route
                        path="/how-it-works/compliance"
                        component={ComplianceHowItWorks}
                      />
                      <Route
                        path="/how-it-works/dashboard"
                        component={DashboardHowItWorks}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        component={TrainingHowItWorks}
                      />
                      <Route path="/landscape" component={Landscape} />
                      <Route path="/mcps" component={MCPRegistry} />
                      <Route path="/mcps/:slug" component={MCPDetail} />
                      <Route path="/old-home">
                        {() => <Redirect to="/" />}
                      </Route>
                      ...
                      <Route
                        ...
                        component={RegionalAnalytics}
                      />
                      <Route
                        path="/regulatory-authority"
                        component={RegulatoryAuthority}
                      />
                      <Route
                      ...
                      <Route
                        path="/watchdog-hub"
                        component={PublicWatchdogHub}
                      />
                      <Route
                        path="/watchdog-leaderboard"
                        component={WatchdogLeaderboard}
                      />
                      <Route
                        path="/watchdog/help-protect-humanity"
                        component={WatchdogHelpProtectHumanity}
                      />
                      <Route
                        path="/watchdog/incident"
                        component={WatchdogIncidentReport}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        component={RatingTheRaters}
                      />
                      <Route
                        path="/claims-register"
                        component={ClaimsRegister}
                      />
                      <Route
                        path="/distribution-integrity"
                        component={DistributionIntegrity}
                      />
                      ...
                      <Route path="/rankings">
                        {() => <Redirect to="/dashboard?tab=leaderboard" />}
                      </Route>
                      ...
                      <Route path="/standards">
                        {() => <Redirect to="/dashboard?tab=standards" />}
                      </Route>
                      ...
                      <Route path="/frameworks/:slug">
                        {(p: any) => (
                          <ContentPage dataset={frameworksdata} slug={p.slug} />
                        )}
                      </Route>
                      <Route path="/sectors/:slug">
                        {(p: any) => (
                          <ContentPage dataset={sectorsdata} slug={p.slug} />
                        )}
                      </Route>
                      <Route path="/industries/:slug">
                        {(p: any) => <IndustryTemplate slug={p.slug} />}
                      </Route>
                      <Route path="/blog/:slug">
                        {(p: any) => (
                          <ContentPage dataset={blogdata} slug={p.slug} />
                        )}
                      </Route>
                      <Route path="/models" component={ModelRegistry} />
                      <Route
                        path="/framework-catalog"
                        component={FrameworkCatalog}
                      />
                      <Route
                        path="/command-center"
                        component={ComplianceCommandCenter}
                      />
                      <Route
                      ...
                      <Route path="/globe">
                        {() => <Redirect to="/gspc-arena?view=globe" />}
                      </Route>
                      <Route path="/registry" component={RegistryAll} />
                      <Route
                        path="/eu-ai-act-checklist"
                        component={EUActChecklist}
                      />
                      <Route path="/checklist" component={EUActChecklist} />
                      <Route path="/gpai" component={GpaiObligations} />
                      <Route
                        path="/foundation-models"
                        component={GpaiObligations}
                      />
                      <Route path="/penalties" component={Penalties} />
                      <Route path="/uk-ai-regulation">
                        {() => <JurisdictionAct jx="uk" />}
                      </Route>
                      <Route path="/canada-aida">
                        {() => <JurisdictionAct jx="canada" />}
                      </Route>
                      <Route path="/china-ai-law">
                        {() => <JurisdictionAct jx="china" />}
                      </Route>
                      <Route path="/singapore-ai-governance">
                        {() => <JurisdictionAct jx="singapore" />}
                      </Route>
                      <Route path="/south-korea-ai-act">
                        {() => <JurisdictionAct jx="korea" />}
                      </Route>
                      <Route path="/us-ai-regulation">
                        {() => <JurisdictionAct jx="usfederal" />}
                      </Route>
                      <Route path="/sec-disclosure">
                        {() => <SECDisclosure />}
                      </Route>
                      <Route path="/sec-ai-disclosure">
                        {() => <SECDisclosure />}
                      </Route>
                      <Route path="/for/:persona">
                        {(params: any) => (
                          <PersonaRouter persona={params.persona} />
                        )}
                      </Route>
                      ...
                      <Route
                        ...
                        component={ConformityAssessment}
                      />
                      <Route
                        path="/ai-governance"
                        component={AiGovernanceHub}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        component={ActSummary}
                      />
                      <Route path="/colorado-ai-act">
                        {() => <UsStateAct state="colorado" />}
                      </Route>
                      <Route path="/texas-ai-act">
                        {() => <UsStateAct state="texas" />}
                      </Route>
                      <Route path="/california-ai-law">
                        {() => <UsStateAct state="california" />}
                      </Route>
                      ...
                      <Route
                        ...
                        component={NistVsEuAct}
                      />
                      <Route path="/nist-eu" component={NistVsEuAct} />
                      <Route
                        path="/iso-42001-vs-eu-ai-act"
                        component={Iso42001VsEuAct}
                      />
                      <Route path="/healthcare-ai-act">
                        {() => <SectorAct sector="healthcare" />}
                      </Route>
                      <Route path="/finance-ai-act">
                        {() => <SectorAct sector="finance" />}
                      </Route>
                      <Route path="/hr-ai-act">
                        {() => <SectorAct sector="hr" />}
                      </Route>
                      <Route path="/energy-ai-act">
                        {() => <SectorAct sector="energy" />}
                      </Route>
                      <Route path="/pharma-ai-act">
                        {() => <SectorAct sector="pharma" />}
                      </Route>
                      <Route path="/defence-ai-act">
                        {() => <SectorAct sector="defence" />}
                      </Route>
                      <Route path="/vanta-alternative">
                        {() => <AltPage comp="vanta" />}
                      </Route>
                      <Route path="/onetrust-alternative">
                        {() => <AltPage comp="onetrust" />}
                      </Route>
                      <Route path="/credo-ai-alternative">
                        {() => <AltPage comp="credo" />}
                      </Route>
                      <Route
                        path="/eu-ai-act-vs-gdpr"
                        component={EuActVsGdpr}
                      />
                      <Route path="/ai-act-vs-gdpr" component={EuActVsGdpr} />
                      <Route
                        path="/eu-ai-act-timeline"
                        component={ActTimeline}
                      />
                      ...
                      <Route path="/sov-towns">
                        {() => <Redirect to="/gspc-arena?view=towns" />}
                      </Route>
                      {/* KILLED (audit §0.2 #22): internal strategy page ("goldmines/black swans") was public. */}
                      <Route path="/crown-jewels">
                        {() => <Redirect to="/" />}
                      </Route>
                      ...
                      />
                      <Route path="/assess">
                        {() => <Redirect to="/dashboard?tab=measured" />}
                      </Route>
                      ...
                      <Route
                        ...
                        component={WatchdogSignup}
                      />
                      <Route path="/training-hub">
                        {() => <Redirect to="/dashboard?tab=play" />}
                      </Route>
                      ...
                      <Route
                        ...
                        component={AgentCouncilFeature}
                      />
                      <Route
                        path="/features/pdca-framework"
                        component={PDCAFrameworkFeature}
                      />
                      <Route
                        path="/features/training-certification"
                        component={TrainingCertificationFeature}
                      />
                      <Route
                        path="/features/watchdog-jobs"
                        component={WatchdogJobsFeature}
                      />
                      <Route
                        path="/certification"
                        component={CertificationV2}
                      />
                      <Route
                      ...
                      <Route path="/public-dashboard">
                        {() => <Redirect to="/transparency" />}
                      </Route>
                      <Route
                        path="/scorecard/:systemId"
                      ...
                      <Route
                        ...
                        component={FoundingCouncilAgreement}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        component={GlobalRegulationTracker}
                      />
                      <Route
                      ...
                      <Route path="/readiness-assessment">
                        {() => <Redirect to="/dashboard?tab=measured" />}
                      </Route>
                      ...
                      <Route path="/integrations">
                        {() => <Redirect to="/dashboard?tab=fabric" />}
                      </Route>
                      ...
                      <Route
                        ...
                        component={VerifyLeaderboard}
                      />
                      <Route
                        path="/packs/eu-article-50"
                        component={Article50Pack}
                      />
                      <Route
                        path="/gpai-evidence"
                        component={GpaiEvidencePack}
                      />
                      <Route
                        path="/cra-readiness"
                        component={CraReadinessKit}
                      />
                      <Route
                      ...
                      />
                      <Route
                        path="/charter/article/:id"
                        component={CharterArticle}
                      />
                      <Route path="/404" component={NotFound} />
                      <Route path="/gone-space" component={Gone} />
                      <Route path="/sov-space">
                        {() => <Redirect to="/gone-space" />}
                      </Route>
                      <Route path="/sovereign-space">
                        {() => <Redirect to="/gone-space" />}
                      </Route>
                      ...
                      <Route path="/authority">
                        {() => <Redirect to="/dashboard?tab=embed" />}
                      </Route>
