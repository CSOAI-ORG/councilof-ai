// GENERATED snapshot of App.tsx routes for the Library IA. Regenerate with the inline node
// script in the Library-IA PR. path + source component + a human title derived from the component.
