...
export const LANE4: Record<string, Lane4Page> = {
  home: {
    ...
    faq: [
      {
        ...
        a: "AI system behaviour against published regulatory provisions, across 13 measured axes (governance, safety, provenance, continuity, conformance, openness, machinery-conformity, care, cross-reality, detector-interop, art5-safeguard, swarm, affect) plus 2 reserved slots. Jail: measured 13 Aug floor exists in a separate stamp (not a ranking), empty on the 12 Aug stamp. Slot-15: reserved, no name assigned. Every published number traces to a signed measurement artefact — not to a self-assessment form.",
      },
      {
    ...
    spotStats: [
      ...
      { value: "13", label: "GSPC measured axes (+ jail: 13 Aug floor in separate stamp, empty on 12 Aug; slot-15: reserved) — frozen 12 August 2026", evidence: "measured" },
    ],
