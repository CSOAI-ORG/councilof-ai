...
export const BATTLECARDS: Battlecard[] = [
  {
    ...
    wedge: "CSOAI is AI-governance-native and open-source: we cover the EU AI Act documentation/classification duties Vanta's infra-evidence model can't, the BFT council reasons rather than checklists, and the open core + free tier reaches the SMBs Vanta's pricing excludes. Every verdict is Ed25519-signed, not just evidence-collected.",
    sources: [
  ...
  },
  {
    ...
    wedge: "CSOAI matches the framework depth (EU AI Act, NIST, ISO 42001 crosswalked in the Hive) but delivers it open-source, self-hostable, and sovereignty-first — plus a live BFT council and Layer 0 signing. Free training + certification and a fair PAYG tier open it to the 99% Credo's price point can't serve.",
    sources: [
