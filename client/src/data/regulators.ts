...
export const REGIMES: Regime[] = [
  {
    ...
    nextDates: [
      { date: "2 Aug 2026", event: "High-risk Annex III obligations + Art. 50 transparency duties apply" },
      { date: "2 Aug 2026", event: "Member States' penalty regimes + market-surveillance authorities operational" },
      { date: "Q3 2026", event: "GPAI Code of Practice adherence reviewed; AI Office guidance expands" },
      { date: "2 Aug 2027", event: "High-risk obligations for Annex I (safety-component/embedded) products apply" },
    ...
    csoai: "Full obligation map, FRIA + conformity workflow, Art. 12 logging signed to Layer 0, and a live Aug-2026 countdown. Comply once — crosswalk to NIST + ISO 42001.",
    hiveSlug: "eu-ai-act",
  },
  {
  ...
  },
  {
    ...
    nextDates: [
      { date: "2026", event: "Act's effective date + AG rulemaking (timeline amended — verify current date)" },
