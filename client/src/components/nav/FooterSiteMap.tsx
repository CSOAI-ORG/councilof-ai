    ...
    <section className="border-t border-gray-200 pt-10 mb-10" aria-labelledby="footer-site-map-heading">
      <div className="mb-6 text-center md:text-left">
        ...
        <p className="mt-1 text-sm text-gray-600 max-w-2xl">
          {POSITIONING.subhead} Product chrome is in the header. The old page groups (Workspace, Software, Measure, Agents, Surfaces) sit in the bar at the bottom. The full estate map is below.
        </p>
      </div>
