...
export function Cta({ slide }: { slide: Slide }) {
  ...
  return (
    <a
      href={slide.href}
      className="mt-8 inline-flex items-center rounded-xl bg-emerald-600 px-6 py-3.5 text-base font-extrabold text-white shadow-lg shadow-emerald-900/15 transition-colors hover:bg-emerald-700"
    >
      {slide.cta}
    </a>
  );
