 ...
 *   (as of 2026-09-01, owner lock: "22 axis · 15 measured · 7 empty") ·
 ...
 *   financial/domain, ADR-001). 15 carry a measurement; 7 are declared
 *   empty/UNMEASURED. Empty cells stay empty. Quote totals.public_count, which
 *   carries both numbers. Owner lock 1 Sep P0 after #1074: never stamp the 7
 *   empty MEASURED. Do not invent 22 measured of 22.
 */
