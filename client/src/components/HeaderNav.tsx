...
export const navigation: NavGroup[] = [
  {
    ...
    submenu: [
      ...
      { section: 'Get a card', name: 'Get measured', href: '/assess', description: 'Booking is not live. Verify stays free.' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Watchdog evidence', href: '/watchdog-hub', description: 'Public evidence and current boundaries; no live incident intake is claimed' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Watchdog evidence', href: '/watchdog-hub', description: 'Inspect published evidence; incident submission is not currently implemented' },
    ],
  },
  {
    name: 'Company',
