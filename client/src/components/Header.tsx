...
const navigation = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: "Measured Scoreboard", href: "/gspc-scoreboard", description: "15 slots × 19 models (12 Aug stamp) — 13 measured, 2 unmeasured — every measured cell attested with n and 95% CI, signed when a card exists" },
