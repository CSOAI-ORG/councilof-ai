...
const navigation = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: "Signed Scoreboard", href: "/gspc-scoreboard", description: "15 public slots × 19 models — 13 measured, 2 unmeasured — frozen 12 August 2026, every measured cell Ed25519-signed with n and 95% CI" },
