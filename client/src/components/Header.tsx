                            ...
                            {item.submenu.map((subItem) => (
                              <div key={subItem.href + subItem.name}>
                                ...
                                <a
                                  ...
                                  rel={
                                    subItem.external ? "noreferrer" : undefined
                                  }
          ...
          <div className="hidden md:flex flex-nowrap items-center gap-2 2xl:gap-3">
            ...
            {user ? (
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="text-muted-foreground h-9 w-9 rounded-full bg-emerald-50 hover:bg-emerald-100"
                    >
              ...
              <>
                ...
                <Link href="/dashboard?tab=measured">
                  <Button
                    size="sm"
                    className="bg-primary text-primary-foreground hover:bg-brand-institutional font-medium shadow-sm"
                  >
                    Request attestation
                  </Button>
                </Link>
              ...
              <div className="pt-4 mt-4 border-t border-border space-y-2 px-4">
                ...
                {user ? (
                  ...
                  <>
                    ...
                    <a href="/dashboard?tab=measured" className="block">
                      <Button
                        className="w-full bg-primary text-primary-foreground hover:bg-brand-institutional"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        Request attestation
                      </Button>
