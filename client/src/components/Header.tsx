...
const navigation: NavGroup[] = [
  {
    ...
    submenu: [
      ...
      { section: 'Specialist boards', name: 'Financial axes', href: '/financial-axes', description: 'The declared financial slots — measured where measured, UNMEASURED and honest where not' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Financial axes', href: '/financial-axes', description: 'The declared financial slots, coverage stated first — never a credit rating' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { section: 'Interop', name: 'Attestation on a public ledger', href: '/xrpl-attest', description: 'Permissionless attach of signed evidence to accounts we do not control. Never a rating' },
