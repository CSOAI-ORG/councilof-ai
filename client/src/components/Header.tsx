...
const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Report an incident', href: '/watchdog', description: 'The public intake for AI behaviour that looks wrong' },
      ...
      { name: 'Compliance Training World', href: '/compliance-training-world/catalog.html', description: 'Industry quests — Art 50(2), bank, insurance, equity, bond, cross-border. Training attests completion, never certification' },
