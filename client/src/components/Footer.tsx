          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-sm">Measured 12 Aug 2026 across 19 models on 13 measured of 15 GSPC slots: EU AI Act Art 5 safeguards best 0.972 (n=36, Wilson 95% [0.858, 0.995]); swarm 0.975; governance 0.700 (n=237). Attested — signed when a card exists. Harness published — recompute it.</p>
              </div>
            </div>
