          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-sm">Frozen 12 August 2026 (UNSIGNED) across 19 models on 13 measured of 15 GSPC slots. Frontends do not bake scores — live data at <a href="/api/gspc" className="underline text-white">/api/gspc</a>. Harness published — recompute it.</p>
              </div>
            </div>
