 ...
 *
 * EACH TILE IS A REAL PAGE HREF. Board and OS go to /os?lobby=board. Verify is
 * /gspc-verify. Assess, evidence, embed, report, insurers, registers are pages.
 * No /?lobby= dump and no openLobby intercept on the homepage.
 *
