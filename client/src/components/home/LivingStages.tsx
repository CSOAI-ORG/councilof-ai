 ...
 * — jail is MEASURED, n=71, separation untested; and a withdrawn consensus claim).
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-[15px] leading-relaxed text-gray-700">
        ...
        the board, and its statistical separation is untested. We print that instead of leaving the
        cell blank, and instead of dressing it up as a pass.
      </p>
