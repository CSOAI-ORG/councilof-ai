        ...
        <div className="relative mx-auto max-w-6xl text-center">
          ...
          <div className="mx-auto mt-10 grid max-w-3xl gap-4 sm:grid-cols-3">
            {[
              ...
              { m: "MAYOR", d: "Set the quest. Hold the contest to the instruments." },
      ...
      <section className="bg-[#07130e] px-6 py-24 text-emerald-50">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-emerald-300">The board · 15 slots</p>
              <h2 className="mt-3 text-4xl font-black">{MEASURED} measured × 19 models</h2>
              <p className="mt-3 max-w-lg text-emerald-100/70">
                A filled cell is a measurement. A dash is honest emptiness. 2 public slots with no score on this stamp. 12 Aug 2026 stamp is unsigned.
              </p>
            </div>
