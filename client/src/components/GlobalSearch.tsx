...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: 'my-courses', title: 'My Courses', description: 'Your enrolled courses and progress', category: 'pages', href: '/my-courses', icon: BookOpen, keywords: ['enrolled', 'progress'] },
  { id: <�s�DO�idden sm:flex items-center gap-0.5 px-1.5 py-0.5 bg-white rounded border text-xs text-gray-400 font-mono">
