...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: 'faq-5', title: 'What is the designed 33-agent Council of AI?', description: 'A designed multi-agent review council for safety oversight — a design, with live independence measured at n_eff 1.21 of 3', category: 'faq', href: '/byzantine', icon: HelpCircle, keywords: ['byzantine', '33', 'council'] },
  ...
  { id: 'new-technology', title: 'Technology & Architecture', description: 'How the designed 33-agent Council of AI and CSOAI platform architecture works', category: 'faq', href: '/technology', icon: Shield, keywords: ['technology', 'architecture', 'byzantine', 'council', 'agents', 'infrastructure', 'platform', 'technical', 'how it works'] },
