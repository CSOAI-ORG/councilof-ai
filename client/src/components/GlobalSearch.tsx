...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: 'certification', title: 'Certification', description: 'CSOAI professional certification program', category: 'pages', href: '/certification', icon: Award, keywords: ['exam', 'certificate', 'credential'] },
  { id: 'certification-exam', title: 'Take Certification Exam', description: 'Start your CSOAI certification exam', category: 'pages', href: '/certification/exam', icon: FileCheck, keywords: ['test', 'exam', 'assessment'] },
  ...
  { id: 'train-ceasai-1', title: 'CSOAI Level 1', description: 'Foundation certification in AI safety', category: 'training', href: '/certification', icon: Award, keywords: ['ceasai', 'certification', 'level 1'] },
  { id: 'train-ceasai-2', title: 'CSOAI Level 2', description: 'Advanced practitioner certification', category: 'training', href: '/certification', icon: Award, keywords: ['ceasai', 'certification', 'level 2'] },
  { id: 'train-ceasai-3', title: 'CSOAI Level 3', description: 'Expert certification in AI safety', category: 'training', href: '/certification', icon: Award, keywords: ['ceasai', 'certification', 'level 3'] },
  ...
  { id: 'faq-2', title: 'How do I get certified?', description: 'Complete training courses and pass the CSOAI certification exam', category: 'faq', href: '/certification', icon: HelpCircle, keywords: ['certification', 'how', 'exam'] },
...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  { id: 'action-take-exam', title: 'Take Certification Exam', description: 'Start your CSOAI certification exam', href: '/certification/exam', icon: FileCheck, color: 'bg-purple-500' },
