...
const SEARCH_INDEX: SearchResult[] = [
  ...
  // Indices · products · powered-by (NEXT_300 #208)
  { id: 'indices-hub', title: 'Labour & AI-economy indices', description: 'AI-economy · human-labour · humanoid-labour — UNMEASURED first, contextual only', category: 'pages', href: '/indices', icon: BarChart3, keywords: ['indices', 'labour', 'economy', 'unmeasured', 'ai-economy'], highlight: true },
  { id: 'indices-ai-economy', title: 'AI Economy Index', description: 'Declared UNMEASURED — measured_score null · never fused into GSPC', category: 'pages', href: '/indices/ai-economy', icon: BarChart3, keywords: ['ai economy', 'index', 'unmeasured'] },
  { id: 'indices-human-labour', title: 'Human Labour Index', description: 'Declared UNMEASURED — not a wage or displacement score', category: 'pages', href: '/indices/human-labour', icon: BarChart3, keywords: ['human labour', 'index', 'unmeasured'] },
  { id: 'indices-humanoid', title: 'Humanoid Labour Index', description: 'Declared UNMEASURED — machinery adjacency only', category: 'pages', href: '/indices/humanoid-labour', icon: BarChart3, keywords: ['humanoid', 'labour', 'index'] },
  { id: 'products-catalog', title: 'Products catalog', description: 'Living catalog — registers honest · scores never sold · HO.2', category: 'pages', href: '/products', icon: Briefcase, keywords: ['products', 'catalog', 'ras', 'sku'], highlight: true },
  { id: 'powered-by', title: 'Powered by Council OS', description: 'Option A white-label attestation licensing — not tokenization', category: 'pages', href: '/powered-by', icon: Zap, keywords: ['powered-by', 'option a', 'white-label', 'attestation'], highlight: true },
