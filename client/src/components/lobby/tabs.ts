...
export const LOBBY_TABS: LobbyTab[] = [
  ...
  { id: "arena", label: "Arena", blurb: "LMArena-style compare — blind rounds on the GSPC board, not a model jury.", path: "/gspc-arena", kind: "local", surface: "measured", cues: /\b(arena|compare|head.?to.?head|lmarena|coliseum|match|rounds)\b/i },
  ...
  { id: "academy", label: "Academy", blurb: "Council Academy — training. Course completion attests training, not conformity.", path: "/academy", kind: "local", surface: "measured", cues: /\b(academy|course|training|learn|teach)\b/i },
