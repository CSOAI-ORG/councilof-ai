...
export const LOBBY_ROUTES: LobbyRoute[] = [
  ...
  },
  {
    ...
    blurb: "Industry quests with signed attestations — bank, insurance, equity, bond.",
    path: "/compliance-training-world/catalog.html",
    group: "analyst",
    cues: /\b(compliance training|training world|industry quest)\b/i,
  },
  {
    label: "Products",
    blurb: "The signed-evidence product family — GPAI, INS, COBOL, RWA, MCP.",
    path: "/products",
    group: "analyst",
    cues: /\b(products?|product family|nine products)\b/i,
  },
];
