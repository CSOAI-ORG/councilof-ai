  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[calc(var(--coai-estate-nav-height,3rem)+1.25rem)] right-5 z-[70] flex h-12 w-12 items-center justify-center rounded-full bg-emerald-800 text-emerald-50 shadow-lg ring-1 ring-emerald-300/30 transition hover:bg-emerald-700 motion-safe:hover:scale-105 motion-reduce:transition-none outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 focus-visible:ring-offset-2"
      >
      ...
      {open && (
        <ErrorBoundary
          fallback={
            <div role="alertdialog" aria-label="Council OS failed to open"
