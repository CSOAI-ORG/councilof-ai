  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      {res && (<section className="mx-auto max-w-3xl px-6 py-8 space-y-4">
        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-[#05140d] p-6"><div className="flex items-baseline justify-between"><div className="text-lg font-bold">Frameworks that apply{gov ? " to " + gov.industry : ""}</div>{gov ? <span className="font-mono text-[10px] uppercase tracking-wide text-emerald-300/40">live - os.meok.ai/govern</span> : null}</div>
