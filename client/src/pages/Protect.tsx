    ...
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="rounded-2xl border border-emerald-400/30 bg-gradient-to-br from-emerald-500/10 to-transparent p-5">
          ...
          <div className="text-[13px] text-emerald-100/70">Real Ed25519 signing on the sovereign backend. Then anyone can verify it — and a deepfake that puts words in your mouth is rejected.</div>
        ...
        <div className="mt-8 rounded-2xl border border-emerald-500/15 bg-white/[0.02] p-5 text-center">
          ...
          <p className="mt-1 text-[13px] text-emerald-100/70">Open-source at the base, signed to Layer 0, consent-first. The Sovereign helps all people of the earth stay who they say they are.</p>
          <div className="mt-3 flex flex-wrap justify-center gap-2">
            ...
            <a href="/pricing" className="rounded-full border border-amber-400/40 bg-amber-400/10 px-3 py-1.5 text-xs font-bold text-amber-100 hover:bg-amber-400/20">Get protected</a>
          </div>
        </div>
      </section>
    </div>
