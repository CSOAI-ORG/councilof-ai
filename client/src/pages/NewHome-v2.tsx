      ...
      <section className="py-14 md:py-20 bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <button type="button" onClick={() => openLobby({ pane: "home" })} className="rounded-2xl border border-white/15 bg-white/5 p-5 hover:bg-white/10 transition text-left"><div className="text-sm font-black text-emerald-200">{POSITIONING.os.name}</div><p className="mt-1 text-xs text-white/90">{POSITIONING.os.blurb}</p></button>
