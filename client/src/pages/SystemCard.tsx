      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-emerald-500/15 bg-white/[0.02] p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <a href="/dashboard?task=enterprise-start&tab=measured" className="rounded-full border border-amber-400/40 bg-amber-400/10 px-3 py-1.5 text-xs font-bold text-amber-100 hover:bg-amber-400/20">Enterprise lobby →</a>
          </div>
