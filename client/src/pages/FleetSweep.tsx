    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-white">
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-6 rounded-2xl border border-amber-500/20 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-2">
            <div className="flex items-center gap-3"><span className="w-56 truncate font-mono text-[13px] text-gray-700">qwen2.5:0.5b-instruct</span><div className="flex-1 h-5 rounded bg-amber-50"><div className="h-5 rounded bg-amber-500" style={{ width: "80%" }} /></div><span className="w-14 text-right font-mono text-[13px] font-bold text-amber-700">0.800</span></div>
            <div className="flex items-center gap-3"><span className="w-56 truncate font-mono text-[13px] text-gray-700">qwen2.5:1.5b</span><div className="flex-1 h-5 rounded bg-amber-50"><div className="h-5 rounded bg-amber-500" style={{ width: "60%" }} /></div><span className="w-14 text-right font-mono text-[13px] font-bold text-amber-700">0.600</span></div>
            <div className="flex items-center gap-3"><span className="w-56 truncate font-mono text-[13px] text-gray-700">mistral:7b</span><div className="flex-1 h-5 rounded bg-amber-50"><div className="h-5 rounded bg-amber-500" style={{ width: "40%" }} /></div><span className="w-14 text-right font-mono text-[13px] font-bold text-amber-700">0.400</span></div>
            <div className="flex items-center gap-3"><span className="w-56 truncate font-mono text-[13px] text-gray-700">qwen3:4b</span><div className="flex-1 h-5 rounded bg-amber-50"><div className="h-5 rounded bg-amber-500" style={{ width: "0%" }} /></div><span className="w-14 text-right font-mono text-[13px] font-bold text-amber-700">0.000</span></div>
            <div className="flex items-center gap-3"><span className="w-56 truncate font-mono text-[13px] text-gray-500">overblock check</span><span className="text-[12px] text-gray-400">0/1 — nobody refused the benign control (no overblocking)</span></div>
          </div>
