...
const FACTS = [
  { k: "What it is", v: "An agentic AI-governance operating system - the BFT Council decides, the OS proves it." },
  { k: "The Council", v: "Five independent AI agents reach Byzantine-fault-tolerant consensus on every major decision." },
