    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-teal-900 to-green-900 text-white py-20">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <p className="mt-5 max-w-2xl text-lg text-emerald-50/90">Every tool is its own hive with an inner sovereign queen — sov3 — that learns from how you use the OS, self-improves, stays aware, and never gets stuck. Each queen is governed by Layer 0, so it can evolve safely. Together they ensemble into one mind.</p>
          ...
          {HIVES.map((h, i) => (
            <a key={h.name} href={h.href} className={"group rounded-2xl border p-5 transition hover:scale-[1.015] " + (i === pulse ? "border-emerald-400 shadow-[0_0_24px_-6px_rgba(16,185,129,.5)]" : "border-gray-200")}>
              ...
              <div className="mt-1 flex items-center gap-2 text-[11px] text-gray-500">
                ...
                Queen sov3 · learning from your interactions · ensembled
              </div>
            </a>
          ))}
        </div>
