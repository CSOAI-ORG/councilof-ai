...
export default function EUAIActCompliance() {
  useEffect(() => { document.title = "EUAIActCompliance | CSOAI"; }, []);
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "CSOAI provides: compliance assessment tools, Council review, CEASAI training for your team, incident reporting system, and continuous monitoring. We handle the technical complexity."
    },
    {
