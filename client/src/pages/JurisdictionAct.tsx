...
const JX: Record<string, J> = {
  ...
  usfederal: {
    ...
    faqs: [
      ...
      { q: "Which US states regulate AI?", a: "Notably Colorado (SB 24-205, the Colorado AI Act), Texas (TRAIGA), California (AI transparency laws) and Utah, plus NYC Local Law 144 for hiring - see the US state pages." },
    ],
  },
};
    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-16">
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <h1 className="mt-3 text-4xl sm:text-5xl font-black tracking-tight">{j.title}</h1>
