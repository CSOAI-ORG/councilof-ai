                ...
                {(data.axes as Axis[]).map((a) => {
                  ...
                  return (
                    <tr key={a.axis} className={`border-b last:border-0 ${focused?.axis === a.axis ? "bg-emerald-50" : ""}`}>
                      ...
                      <td className="p-3 font-mono tabular-nums whitespace-nowrap" data-testid={`accuracy-${a.axis}`}>
                        {acc.state === "figure" && (
                          <>
                            {acc.prefix}{acc.text}
                            {acc.lowerBound && (
                      ...
                      <td className="p-3 font-mono tabular-nums whitespace-nowrap text-gray-600" title={ci.title}>{ci.text}</td>
