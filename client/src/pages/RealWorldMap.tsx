  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      <section className="relative overflow-hidden mx-auto max-w-6xl px-6 pt-16 pb-4">
        ...
        <h1 className="relative mt-2 text-5xl sm:text-6xl font-black tracking-tight">The living <span className="bg-gradient-to-r from-emerald-300 via-emerald-400 to-teal-300 bg-clip-text text-transparent">globe.</span></h1>
        <p className="mt-3 max-w-2xl text-emerald-100/80">Photorealistic 3D Earth - the real-world layer of Sov Space. The same world pixel-streams from Unreal Engine 5 in the full OS.</p>
      </section>
