...
const checklistItems = [
  ...
  {
    title: "CSOAI Certification (CSOAI specific)",
    description:
      "Complete the 20-week CSOAI program to earn an externally recognized certificate that demonstrates your organization meets EU AI Act obligations.",
    link: "/certification",
  },
];
...
const faqs = [
  ...
  {
    question: "How long does CSOAI certification take?",
    answer:
      "The standard CSOAI program runs 20 weeks: 8 weeks of structured coursework, 8 weeks of guided implementation, and 4 weeks of final assessment and Byzantine Council review. Accelerated tracks are available for teams with existing compliance infrastructure.",
  },
  {
    question: "Does CSOAI cover EU AI Act specifically?",
    answer:
      "Yes. The CSOAI curriculum is explicitly mapped to every high-risk requirement in the EU AI Act, including risk classification, conformity assessment, technical documentation, post-market monitoring, human oversight, and quality management.",
  },
  {
    question: "Can I get certified if my AI is still in development?",
    answer:
      "Absolutely. CSOAI certification applies to your organization's compliance processes and governance framework, not just deployed systems. Getting certified during development ensures you build compliance in from the start—cheaper and faster than retrofitting later.",
  },
  {
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="border-2 border-emerald-200 dark:border-emerald-800 hover:border-emerald-400 dark:hover:border-emerald-600 transition-colors h-full">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  CSOAI operates under CSOAI Limited, UK Companies House
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container max-w-4xl mx-auto px-4 py-20 relative text-center">
            ...
            <p className="text-xl text-emerald-100 mb-8">
              ...
              Start your CSOAI certification today.
            </p>
            <Link href="/certification">
              <Button
                size="lg"
