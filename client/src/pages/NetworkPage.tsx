      ...
      <section className="mx-auto max-w-6xl px-6 py-9">
        ...
        <div className="mt-10 rounded-2xl border border-emerald-500/15 bg-white/[0.02] p-6 text-center">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            ...
            <a href="/?lobby=home" className="rounded-xl border border-emerald-400/40 px-5 py-2.5 text-sm font-semibold text-emerald-100 hover:bg-white/5">Open Council OS →</a>
