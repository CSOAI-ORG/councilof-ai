...
const USPS = [
  ...
  { icon: BarChart3, title: "Indices declared UNMEASURED", body: "AI-economy · human-labour · humanoid-labour — contextual firewall only. Empty until INDEX-METHOD freezes a bank. Never fused into GSPC grades.", href: "/indices" },
...
const HOME_FAQ = [
  {
    q: "Are you a router, a harness, or both?",
    a: "Both — in different layers. Eunomia is the governance router: 291+ MCP routing rules for frameworks, law, benchmarks, and compute — governance instruments, not LLM provider proxies. The measurement harness is downstream proof: the signed GSPC board, arena traces, and RECEIPT-SPEC cards on GET /api/gspc. We do not compete on Stripe/OpenRouter-style LLM toll roads; we prove routing was correct. Council OS is one workspace where both layers meet.",
  },
  {
