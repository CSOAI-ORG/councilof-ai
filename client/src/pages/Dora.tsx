...
// /dora — financial-services vertical. DORA is in active enforcement in 2026; the
...
const FAQ = [
  { q: "What is DORA and who does it apply to?", a: "The Digital Operational Resilience Act (Regulation (EU) 2022/2554) sets binding ICT and cyber-resilience rules for banks, insurers, investment firms, crypto-asset service providers and their critical ICT third parties across the EU. It is in active enforcement in 2026." },
  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <p className="font-mono text-[11px] uppercase tracking-[3px] text-emerald-300/70">Financial services · DORA · active enforcement 2026</p>
        ...
        <div className="mt-8 flex flex-wrap gap-2">
          <a href="/classifier" className="rounded-xl bg-emerald-500 px-5 py-2.5 text-sm font-black text-[#03110b] hover:bg-emerald-400">Classify your financial AI →</a>
