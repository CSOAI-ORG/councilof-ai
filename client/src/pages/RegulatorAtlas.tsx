  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <section className="mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="mt-6 rounded-2xl border border-emerald-400/25 bg-emerald-500/5 p-5 text-center">
          <div className="text-sm font-bold text-emerald-100">East-West desks — signed streams free forever</div>
          <p className="mx-auto mt-1 max-w-2xl text-[13px] text-emerald-100/70">One signed measurement, mapped across EU, UK, Illinois, and China. Mapping is not a determination. Verify the stream in 10 minutes, no account, no fee.</p>
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            <a href="/east-west/desks/eu" className="rounded-xl border border-emerald-400/40 px-4 py-2 text-xs font-semibold text-emerald-100 hover:bg-white/5">EU desk</a>
            <a href="/east-west/desks/uk" className="rounded-xl border border-emerald-400/40 px-4 py-2 text-xs font-semibold text-emerald-100 hover:bg-white/5">UK desk</a>
            <a href="/east-west/desks/illinois" className="rounded-xl border border-emerald-400/40 px-4 py-2 text-xs font-semibold text-emerald-100 hover:bg-white/5">Illinois desk</a>
            <a href="/east-west/desks/china" className="rounded-xl border border-emerald-400/40 px-4 py-2 text-xs font-semibold text-emerald-100 hover:bg-white/5">China desk</a>
            <a href="/east-west/verify" className="rounded-xl bg-emerald-500 px-4 py-2 text-xs font-bold text-[#03110b] hover:bg-emerald-400">Verify a card →</a>
          </div>
        </div>
