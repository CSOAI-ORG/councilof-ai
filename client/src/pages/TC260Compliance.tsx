...
export default function TC260Compliance() {
  useEffect(() => { document.title = "TC260Compliance | CSOAI"; }, []);
  ...
  const faqs = [
    ...
    { question: "How does CSOAI help with TC260?", answer: "CSOAI provides TC260 compliance assessment, Byzantine Council review, and CSOAI training. We help you implement required algorithm audits and data security controls." },
