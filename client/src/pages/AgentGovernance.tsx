...
const RISKS = [
  ...
  { t: "Inter-agent risk", d: "Multi-agent chains amplify errors no single agent owns.", ctrl: "33-agent Council of AI review — no single model decides" },
...
const FAQ = [
  ...
  { q: "How does CSOAI govern AI agents?", a: "CSOAI is agentic-native: every agent carries a signed agent card (purpose, tools, data sources, guardrails) discoverable via A2A, its actions can be reviewed by a 33-agent Council of AI held to a 0.95 care-floor, and every decision is sealed to Layer 0 with Ed25519 for a verifiable, reproducible record — mapped to the EU AI Act, NIST AI RMF and ISO 42001." },
  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mt-4 max-w-3xl text-lg text-emerald-100/80">Agents plan, call tools and act. That's a new risk surface — and CSOAI was built agentic-native for it: <b>signed agent cards</b>, a <b>33-agent Council of AI</b>, and <b>Ed25519 Layer-0 attestations</b>, mapped to EU AI Act Art. 14 &amp; 50. Not documentation — control.</p>
