      ...
      <section className="relative overflow-hidden border-b border-emerald-500/15">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-14 pb-9 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-emerald-100/80">
            Live-researched, cited intel on the AI-governance incumbents — their funding, customers, and the exact gaps
            where CSOAI&apos;s open, signed, council-driven OS wins. Wilson moat: frozen-bank intervals with usable n;
            labour/economy indices stay{" "}
            <a href="/indices" className="text-emerald-300 underline">UNMEASURED</a> (scores never sold). Measurement,
            not accusation.
          </p>
        </div>
      </section>
