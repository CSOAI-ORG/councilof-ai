...
export default function ComplianceHowItWorks() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "SOAI-PDCA combines Safety Oversight AI (the designed 33-agent Council of AI) with the Deming Cycle (Plan-Do-Check-Act). It's a continuous improvement methodology that ensures your compliance keeps improving over time."
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mb-20">
          ...
          <p className="text-center text-gray-700 mb-12 max-w-3xl mx-auto">
            SOAI-PDCA combines Safety Oversight AI (the designed 33-agent Council of AI) with the Deming Cycle to ensure your compliance keeps improving over time.
          </p>
          ...
          <Card className="p-12 border-2 border-emerald-200">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-700">The designed 33-agent Council of AI independently reviews your AI systems and compliance practices (design; live independence measured at n_eff 1.21 of 3). No vendor bias, no conflicts of interest.</p>
              </div>
              <div>
