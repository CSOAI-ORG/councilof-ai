    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-16">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <h1 className="mt-3 text-4xl sm:text-5xl font-black tracking-tight">Everyone shipped one agent. We shipped a Council.</h1>
          <p className="mt-4 max-w-2xl text-lg text-emerald-50/90">2026 is the year of the governance agent. But a single agent deciding your compliance is a single point of failure. CSOAI runs five - and they have to agree.</p>
        </div>
      </section>
