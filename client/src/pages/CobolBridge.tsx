...
// migration becomes continuous, verifiable compliance evidence.
//
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 max-w-3xl text-gray-600">
            Instead of a rewrite that loses the paper trail, the migration is instrumented: every mapping and transformation is captured as data, so the lineage a supervisor asks for falls out of the work rather than being reconstructed after the fact.
          </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3 text-sm">
          ...
          <span className="text-emerald-500 font-bold">→</span>
          <span className="rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 font-mono text-gray-700">Continuous, verifiable evidence</span>
        </div>

        <div className="mt-6 rounded-2xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
          <span className="font-bold">Status: UNMEASURED.</span> This on-ramp is a described pathway. The cobolbridge.ai → signed-measurement pipeline is not yet a live, measured integration; it is presented as UNMEASURED until it is built and run, in keeping with our three-state honesty.
        </div>
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-14">
          ...
          <ul className="mt-4 max-w-3xl space-y-3 text-gray-700">
            ...
            <li className="flex gap-3"><span className="mt-1 text-emerald-600">◆</span><span>cobolbridge.ai is a modernization tool. The Council of AI measurement is <span className="font-semibold">independent of it</span> — the attestation is about the evidence, not an endorsement of the migration.</span></li>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-8 sm:p-10">
          ...
          <p className="mt-2 max-w-2xl text-emerald-900/90">
            If you are modernizing a COBOL core under DORA, Basel III/IV, SOX or Solvency II, the lineage you have to produce anyway can become continuous, signed evidence. Talk to us about the on-ramp. Verify is free; a grade is never sold; there are no public prices.
          </p>
