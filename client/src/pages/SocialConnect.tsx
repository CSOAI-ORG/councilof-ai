    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 grid gap-8 lg:grid-cols-[1fr_320px] items-start">
        ...
        <div className="rounded-2xl border border-gray-200 p-6">
          ...
          <a href="/sovereign" className="mt-4 inline-block rounded-xl bg-emerald-600 px-4 py-2 text-sm font-bold text-white hover:bg-emerald-500">Save to your Sovereign -&gt;</a>
