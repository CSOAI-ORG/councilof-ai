...
<<<<<<< HEAD
          <p className="mt-3 text-xs text-gray-400">Every post your character makes is governed by your BFT setup and signed with your Sovereign passport. Configure once - it carries across CSOAI and MEOK OS.</p>
          <a href="/council-hub" className="mt-4 inline-block rounded-xl bg-emerald-600 px-4 py-2 text-sm font-bold text-white hover:bg-emerald-500">Save to your Council Hub -&gt;</a>
=======
