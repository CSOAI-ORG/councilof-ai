...
const FAQ = [
  ...
  { q: "How does CSOAI treat CRA?", a: "CSOAI measures and signs evidence (SBOM workflow, incident runbook, Ed25519 receipts). It does not certify CRA conformity, issue a CE mark, or sell a ranking slot. Confirm scope with counsel." },
];
