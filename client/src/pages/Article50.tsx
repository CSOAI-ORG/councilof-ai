...
// Article 50 transparency obligations apply from 2 Aug 2026; GPAI models already on
// the market before 2 Aug 2025 have until 2 Aug 2027 to comply.
// Fines up to €15M or 3% of worldwide turnover.
...
const FAQ = [
  ...
  { q: "When does Article 50 take effect?", a: "Article 50 transparency obligations — and the enforcement powers behind them — apply from 2 August 2026. GPAI models already placed on the market before 2 August 2025 have a transition period until 2 August 2027 to come into full compliance; systems launched from 2 August 2026 must meet Article 50 immediately." },
...
export default function Article50() {
  useEffect(() => { document.title = "EU AI Act Article 50 — the transparency cliff (from 2 Aug 2026) | CSOAI"; }, []);
    ...
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-emerald-400/40 bg-emerald-500/10 p-4"><div className="text-3xl font-black text-emerald-200">{aug27}</div><div className="text-sm text-emerald-100/80">days → legacy GPAI (on market before 2 Aug 2025) full-compliance (2 Aug 2027)</div></div>
        </div>
