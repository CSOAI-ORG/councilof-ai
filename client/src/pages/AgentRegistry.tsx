  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mt-3 max-w-3xl text-sm text-emerald-100/60">Every card is a ~3KB record signed against the published signer <code className="text-emerald-300">f4b4278d…</code>. {ANCHORING_CLAIM} OpenTimestamps anchoring is roadmap, not yet wired. The post-quantum ML-DSA-65 (FIPS-204) signer is built, not shipped.</p>
