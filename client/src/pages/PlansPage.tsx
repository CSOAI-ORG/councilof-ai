...
export default function PlansPage() {
  ...
  const tiers: Tier[] = [
    ...
    { name: "Enterprise", price: "Custom", sub: "from ~$30k / yr", tag: "Governance-grade", cta: "Talk to us", href: "/enterprise", feats: ["Full EU AI Act audit suite", "Dedicated Council of AI + defence", "Data residency + SLA", "SAML, audit export (CSV/JSON/Parquet)", "Onboarding + success"] },
  ];
