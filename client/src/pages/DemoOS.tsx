...
const STEPS: Step[] = [
  ...
  { say: "And if one plays up? I auto-confirm the scene - public and consented cameras, WiFi sensing, no facial recognition - clear it through our Rainbow Stack seven-layer AI-security defense, and stop it before any harm.", layer: { tag: "cyber", on: true } },
