...
const STEPS: Step[] = [
  ...
  { say: "Now up to orbit - the instrument on a real-world globe. Thirteen measurement axes, each anchored where its law was made.", wins: [{ title: "◉ Council Space — the 13-axis globe, live", src: "/sov-space", slot: "tr" }], fly: { lng: -0.118, lat: 40, height: 22000000 }, layer: { tag: "sats", on: true } },
