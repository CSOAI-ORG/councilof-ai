...
const STEPS: Step[] = [
  ...
  { say: "Now up to orbit - the instrument on a real-world globe. Thirteen measurement axes, each anchored where its law was made.", wins: [{ title: "◉ Council Space — the 13-axis globe, live", src: "/gspc-arena", slot: "tr" }], fly: { lng: -0.118, lat: 40, height: 22000000 }, layer: { tag: "sats", on: true } },
  ...
  { say: "Here's the model registry - thirteen axes, every leader model named, every score recomputable from the published harness.", wins: [{ title: "▦ Model Registry — 13 axes, live", src: "/models", slot: "tr" }], fly: { lng: -0.118, lat: 51.509, height: 60000 } },
