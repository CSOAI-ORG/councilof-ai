...
const STEPS: Step[] = [
  ...
  { say: "And it's not a dashboard - it's a whole operating system. 377 governed tools, keyless and live, from crosswalks to cyber to attestation, all running on one Sovereign brain. An app store for AI governance. No one else ships it this way.", wins: [{ title: "The Sovereign OS - 377 governed tools", src: "/os", slot: "c" }], full: true },
  ...
  { say: "And you don't even have to come to us - governance goes to you. One command, npx csoai-governance-mcp, drops this entire Layer 0 - signing, verification, the council, all 377 tools - into any AI agent you already run. We are the governance layer under the whole ecosystem.", wins: [{ title: "CSOAI Governance MCP - one command", src: "/distribution", slot: "tr" }], full: true },
