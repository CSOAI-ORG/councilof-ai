...
const STEPS: Step[] = [
  ...
  { say: "And it's not a dashboard - it's a whole operating system. Published tools, keyless and live, from crosswalks to cyber to attestation, all running on one Council engine. The count is live from the gateway, not a slogan.", wins: [{ title: "The Council OS - published tools", src: "/?lobby=home", slot: "c" }], full: true },
