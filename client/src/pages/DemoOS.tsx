...
const STEPS: Step[] = [
  ...
  { say: "And it's not a dashboard - it's a whole operating system. Published governed tools, keyless and live, from crosswalks to cyber to attestation, all running on one Council engine.", wins: [{ title: "Council OS", src: "/?lobby=home", slot: "c" }], full: true },
...
const NAV_GROUPS: { g: string; items: { n: string; src: string }[] }[] = [
  ...
  { g: "Build & run", items: [{ n: "Tool Commons", src: "/?lobby=tools" }, { n: "OSCAL Studio", src: "/oscal" }, { n: "Command Center", src: "/command-center" }, { n: "Plans & pricing", src: "/plans" }, { n: "Council OS", src: "/?lobby=home" }] },
];
...
const BOTTOM_NAV: { n: string; src: string; g: string }[] = [
  { n: "Graph", src: "/graph", g: "◎" }, { n: "Council", src: "/try", g: "⚖" }, { n: "Hive", src: "/hive", g: "⬡" }, { n: "Watchdog", src: "/watchdog-map", g: "o" }, { n: "Scan", src: "/scan", g: "*" }, { n: "Atlas", src: "/regulators", g: "+" }, { n: "Network", src: "/network", g: "◇" }, { n: "OS", src: "/?lobby=home", g: "⊞" },
];
        ...
        <div className="absolute inset-0 z-[60]" onClick={() => setDrawer(false)}>
          ...
          <div onClick={(e) => e.stopPropagation()} className="absolute right-0 top-0 h-screen w-[360px] max-w-[92vw] overflow-y-auto bg-white text-gray-900 shadow-2xl">
            ...
            <div className="p-4">
              ...
              <a href="/?lobby=home" className="mt-3 block rounded-xl bg-emerald-600 px-3 py-2.5 text-center text-sm font-bold text-white hover:bg-emerald-500">Open Council OS →</a>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="border-t border-emerald-500/15 p-3">
            {ending ? (
              <div className="grid grid-cols-2 gap-2">
                ...
                <a href="/?lobby=home" className="rounded-xl bg-emerald-500 px-3 py-2 text-center text-xs font-bold text-[#03110b] hover:bg-emerald-400">Enter Council OS</a>
              </div>
            ) : !paused ? (
