...
export default function SovereignMinds() {
  useEffect(() => { document.title = "Sovereign Minds — the cognition & voice layer · CSOAI"; }, []);
  return (
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <h1 className="mt-3 text-4xl sm:text-5xl font-black tracking-tight">Sovereign Minds</h1>
