...
const schedules = [
  ...
  { id: "D", title: "Training Curriculum", desc: "CSOAI certification program content and exam specifications", icon: BookOpen },
...
const integrationSteps = [
  ...
  },
  {
    ...
    details: ["5 license tiers", "CSOAI certification", "Annual renewals", "Compliance audits"]
  },
  {
            ...
            <CardContent className="p-6">
              <div className="flex flex-wrap justify-center items-center gap-4">
                {[
                  ...
                  { step: "2", label: "Staff complete CSOAI Certification", icon: BookOpen },
