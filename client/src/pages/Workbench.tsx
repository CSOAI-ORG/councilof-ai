      ...
      <div className="mx-auto max-w-6xl px-5 py-10">
        ...
        <div className="mt-7 grid gap-5 lg:grid-cols-[260px_1fr]">
          ...
          <div className="rounded-2xl border border-emerald-500/20 bg-[#04120c] p-3">
            ...
            <a href="/os?lobby=tools" className="mt-3 block rounded-lg border border-emerald-500/20 px-3 py-2 text-center text-[12px] font-semibold text-emerald-200/80 hover:bg-white/5">Published tools →</a>
          </div>
