        ...
        {info ? (
          <div className={"mt-8 rounded-2xl border p-5 " + (amber ? "border-amber-400/50 bg-amber-500/[0.07]" : "border-emerald-400/40 bg-emerald-500/[0.06]")}>
            ...
            <div className="mt-5 flex flex-col gap-2 sm:flex-row">
              <button onClick={() => go("/?lobby=home")} className={"flex-1 rounded-xl px-4 py-2.5 text-center text-sm font-bold " + (amber ? "bg-amber-400 text-[#1a1206] hover:bg-amber-300" : "bg-emerald-500 text-[#03110b] hover:bg-emerald-400")}>Enter your OS →</button>
          ...
          <div className="mt-8 rounded-2xl border border-emerald-500/20 bg-[#05140d] p-5">
            ...
            <div className="mt-5 flex flex-col gap-2 sm:flex-row">
              <button onClick={() => go("/?lobby=home")} className="flex-1 rounded-xl bg-emerald-500 px-4 py-2.5 text-center text-sm font-bold text-[#03110b] hover:bg-emerald-400">Enter your OS →</button>
              <button onClick={() => go("/demo")} className="flex-1 rounded-xl border border-emerald-400/40 px-4 py-2.5 text-center text-sm font-bold text-emerald-100 hover:bg-white/5">▶ Take the guided tour</button>
            </div>
          </div>
        )}
