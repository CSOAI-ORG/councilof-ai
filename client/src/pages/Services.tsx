...
const SERVICES: Svc[] = [
  { name: "Live Council of AI", glyph: "BFT", body: "Ask any AI-governance question and watch five independent agents debate and reach fault-aware consensus consensus - with the frameworks that apply and why.", href: "/try", cta: "Try it free" },
