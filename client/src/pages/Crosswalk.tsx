  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mt-4 max-w-3xl text-lg text-emerald-100/80">How published AI-governance and adjacent compliance frameworks map to shared controls. Comply once, evidence everywhere. The signed, article-level version runs inside <a href="/?lobby=home" className="text-emerald-300 underline">Council OS</a>.</p>
