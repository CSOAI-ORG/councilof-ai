...
export default function NISTAIRMFCompliance() {
  ...
  const faqs = [
    ...
    { question: "How does CSOAI help with NIST compliance?", answer: "CSOAI provides assessment tools, Council review, and CEASAI training covering NIST AI RMF. We help you map your systems to NIST categories and implement required controls." },
