  ...
  return (
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      ...
      <section className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mt-8 text-center text-xs text-emerald-300/50">Every tool is governed by Layer 0 and signed. Open, MIT-licensed, sovereign by construction. Live via os.meok.ai.</p>
      </section>
    </div>
  );
}
