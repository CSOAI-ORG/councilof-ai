...
// Ethicist, Strategist) deliberate with Byzantine-fault-tolerant voting and return a
...
function agentLine(a: Agent, d: Domain): string {
  switch (a.id) {
    ...
    case "strategist": return d.tier === "Prohibited" ? "Kill or redesign now — there is no market for a banned system. Pivot the value prop to a compliant adjacent use." : d.tier === "High-risk" ? "Start the conformity programme this quarter — the Aug 2026 obligations don't wait. First move: a gap assessment against the six Art. 9-15 duties, then close the biggest gap first." : "Cheapest insurance in tech: ship the disclosure + labelling now, document it, and revisit risk tier at every material change.";
    default: return "";
  }
}
