              ...
              <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
                ...
                <div className="mt-5 border-t border-emerald-200 pt-4">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    <a href="/?lobby=home" className="rounded-xl border border-emerald-300 bg-white px-4 py-2 text-sm font-semibold text-emerald-800 hover:bg-emerald-50">Open it in Council OS →</a>
                  </div>
                </div>
              </div>
            )}
