...
export default function Standards() {
  const frameworks = [
    ...
    },
    {
      ...
      date: "2025-01-15",
      description: "CSOAI's measurement framework for AI safety governance: published measurement harnesses, deterministic grading, Ed25519-signed results, and public oversight.",
