    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="/?lobby=home" className="rounded-xl border border-emerald-300 px-5 py-2.5 text-sm font-semibold text-emerald-700 hover:bg-emerald-50">Enter the OS →</a>
        </div>
      </section>
    </div>
  );
