...
const LOOP: Stage[] = [
  ...
  { id: "vote", n: "Vote (BFT)", glyph: "4", body: "fault-aware consensus vote: passes only on supermajority, so one corrupt agent can't decide." },
...
const FAQ = [
  ...
  { q: "Why does BFT matter?", a: "fault-aware consensus means the swarm reaches the right answer even if some agents lie or break. The math behind Bitcoin and the Athenian Boule - now governing AI." },
    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-16">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <p className="mt-4 max-w-2xl text-lg text-emerald-50/90">Every tool in the OS is a hive with an inner Sovereign queen. Workers gather, the queen proposes, the swarm debates, and a fault-aware consensus vote decides - so no single agent can corrupt the whole. The hive attests, learns, and never gets stuck.</p>
        </div>
      </section>
