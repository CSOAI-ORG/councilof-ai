...
const INDICES_FAQ = [
  {
    q: "Why are these indices empty?",
    a: "Because inventing a score would be worse than an empty cell. AI-economy, human-labour, and humanoid-labour are declared UNMEASURED until INDEX-METHOD freezes a bank and usable n. Absence is not zero — it is honesty.",
  },
  {
    q: "Will you fill them with GPU / RunPod overnight?",
    a: "No. RunPod is for model-axis and arena work. It does not authorize inventing labour or AI-economy MEASURED scores. See docs/RUNPOD_POLICY.md.",
  },
  {
    q: "Can these numbers enter a GSPC grade?",
    a: "Never. They are a contextual firewall only — never SHA-256 / Ed25519 GSPC cell inputs. Same rule on Council OS and DSH.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 grid gap-4">
        ...
        <div className="pt-6">
          <FaqBlock
            title="Why empty indices?"
            intro="UNMEASURED first — the product is honesty, not a filled spreadsheet."
            items={INDICES_FAQ}
          />
        </div>
