...
const APPS: App[] = [
  ...
  { name: "God's Eye — cyber self-scan", desc: "Scan your own business with a stack of reputable open-source security tools; the Sovereign triages the findings, maps them to the frameworks that bite, and guides the fix. Signed to Layer 0.", href: "/scan", glyph: "🛰", tone: "from-cyan-500/20 to-emerald-400/5 border-cyan-400/30", pro: true },
  ...
  { name: "Why CSOAI vs the rest", desc: "What we do that Vanta, Credo and OneTrust don't — open-source core, free training + certification, BFT council, self-scan, and value back to you, not middlemen.", href: "/why", glyph: "⭐", tone: "from-amber-500/20 to-emerald-400/5 border-amber-400/30" },
  ...
  { name: "Working Tools", desc: "Article 50 passport generator, real-time compliance dashboard, heatmap, BFT council votes, charter network, capability matrix, buyer evidence index — all in-browser, no sign-up.", href: "/tools/index.html", glyph: "⚒", tone: "from-emerald-500/20 to-teal-400/5 border-emerald-400/30", ext: true },
