...
const APPS: App[] = [
  ...
  { name: "Live Demo & Tour", desc: "Watch the OS run itself — the Council assistant flies the globe, opens the tools and narrates it all, by voice and chat. 2-min demo or 6-min tour.", href: "/demo", glyph: "▶", tone: "from-emerald-500/30 to-teal-400/10 border-emerald-400/40" },
  ...
  { name: "ONE OS — agents & humanoids", desc: "The proof of concept: live-track every agent and humanoid, PDCA auto-simulation, and watch the Council assistant stop a rogue swarm before it ungoverns — signed.", href: "/poc", glyph: "⬢", tone: "from-emerald-500/25 to-rose-400/10 border-emerald-400/35", pro: true },
  ...
  { name: "The Regulator Atlas", desc: "Every major AI + cyber regime — EU AI Act, NIST, ISO 42001, NIS2, DORA, CRA and more — with the top 7 tools you need and the next 7 dates that matter. Live Council read on any of them.", href: "/regulators", glyph: "🗺", tone: "from-emerald-500/20 to-teal-400/5 border-emerald-400/30" },
  { name: "Cyber self-scan", desc: "Scan your own business with a stack of reputable open-source security tools; the Council assistant triages the findings, maps them to the frameworks that bite, and guides the fix. Signed to Layer 0.", href: "/scan", glyph: "🛰", tone: "from-cyan-500/20 to-emerald-400/5 border-cyan-400/30", pro: true },
  ...
  { name: "Council Academy", desc: "Learn governance as a guided journey \u2014 Foundations to certification.", href: "/academy", glyph: "\u2738", tone: "from-violet-500/20 to-violet-400/5 border-violet-400/30" },
