 ...
 * (Enter Council OS). This page keeps the town / arena / axis board for readers and
...
const NAV: NavGroup[] = [
  ...
  },
  {
    label: "Measure",
    items: [
      { name: "GSPC axis board", href: "#axes", note: "living board · counts from /api/gspc" },
    ...
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto flex max-w-7xl gap-8 px-5 py-8 lg:px-8">
        ...
        <main className="min-w-0 flex-1 space-y-10">
          ...
          <footer className="border-t border-slate-100 pt-6 text-[12px] text-slate-400">One measured surface — the game, the arena, the axis board and the Council together.</footer>
        </main>
      </div>
    </div>
  );
