...
const APPS: App[] = [
  ...
  { name: "Governance Workbench", desc: "The AI OS as a workbench on the Sovereign OS — run a governance skill and get a signed, reproducible, council-reviewed artifact. Every output sealed to Layer 0. The auditable-artifact standard, done the CSOAI way.", href: "/workbench", glyph: "🧬", tone: "from-emerald-500/20 to-cyan-400/5 border-emerald-400/30", pro: true },
