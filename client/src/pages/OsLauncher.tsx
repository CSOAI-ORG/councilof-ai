    ...
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto flex max-w-7xl gap-8 px-5 py-8 lg:px-8">
        ...
        <main className="min-w-0 flex-1 space-y-10">
          ...
          <section>
            {/* Institution badge — same language as homepage first paint */}
            ...
            <h1 className="mt-4 text-3xl font-black tracking-tight sm:text-4xl">Council OS</h1>
            <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-slate-600">
              The living GSPC board, verify, Council Space, and the ask bar — one workspace.
              Counts come from GET /api/gspc. Empty cells stay empty. Measurement credential,
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <a href="/gspc-verify" className={`inline-flex min-h-[44px] items-center rounded-lg border border-emerald-200 bg-white px-5 py-2.5 text-sm font-bold text-emerald-700 transition hover:bg-emerald-50 ${FOCUS}`}>Verify a card — free</a>
            </div>
          </section>
