      ...
      <section className="mx-auto max-w-3xl px-6 py-12 text-center">
        ...
        <div className="mt-6 rounded-2xl border border-emerald-500/15 bg-black/20 p-5">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            <a href="/?lobby=home" className="rounded-full border border-emerald-400/30 bg-emerald-500/5 px-3 py-1.5 text-xs font-semibold text-emerald-100 hover:bg-emerald-500/15">Ask Council OS</a>
