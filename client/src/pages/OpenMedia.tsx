    ...
    <div className="min-h-screen bg-[#03110b] text-emerald-50">
      <section className="relative overflow-hidden border-b border-emerald-500/15">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pt-16 pb-10 text-center">
          ...
          <h1 className="mt-3 text-5xl sm:text-6xl font-black tracking-tight">Open <span className="bg-gradient-to-r from-emerald-300 via-emerald-400 to-teal-300 bg-clip-text text-transparent">commons.</span></h1>
