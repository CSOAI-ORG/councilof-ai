      ...
      <div className="mx-auto max-w-5xl px-6 py-14">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-emerald-600/15 bg-white p-5">
            ...
            <p className="mt-1 text-sm text-gray-600">The board shows which measurement slots a system fails, with the n behind each result. A failure rate with a sample size and a Wilson interval is a frequency input, not a marketing claim.</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Insurers() {
  return (
    <DeckPage
      ...
      description="Signed, deterministic AI measurement an underwriter can verify offline."
