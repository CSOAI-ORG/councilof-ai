...
export default function EunomiaData() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mt-2 text-xs text-slate-400">SOVOS Part IX: this is the lawful <b>commercial</b> lane — insurers, bond desks, vendors buy <b>data</b> (the signed enforcement record + deadline calendar) per query. Regulators + the public get the signed stream <b>free</b> at <a href="/first-fine-watch" className="text-emerald-300 underline">/first-fine-watch</a> (R8).</p>
