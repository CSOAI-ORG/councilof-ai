 ...
 * to a model do it with a plain fetch to our own gateway (/api/chat), which needs no
 * SDK. A manual audit of every fetch on 1 Aug 2026 — the day before Article 50 became
 * enforceable — found 14 components that call the configured /api/chat model endpoint. They are
...
export const SURFACES: Surface[] = [
  ...
  { route: "/assess", label: "Readiness assessment", nature: "rule_based",
    mechanism: "A deterministic text screen points to possible provisions and reports caller-asserted control coverage. The API does not verify those claims or decide legal tier or compliance. If signed, the signature preserves only the scoped screening bytes.",
  ...
  { route: "/classifier", label: "Annex III classifier", nature: "ai_system",
    mechanism: "CORRECTED 1 Aug 2026 — v1.0.0 registered this as keyword matching; the code actually sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Article 50(1) notice is mounted above the input.",
  ...
  { route: "/cyber-scan", label: "Withdrawn cyber-scan prototype", nature: "rule_based",
    mechanism: "This route now renders a no-index evidence-review notice. It does not run a scan, call a model, fix findings, or issue signed evidence.",
    evidence: ["client/src/pages/ContentReviewNotice.tsx"] },
  ...
  { route: "/globe", label: "WorldGlobe", nature: "ai_system",
    mechanism: "'Ask your Council assistant about the world' sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The answer can also drive the globe (layers, flights) through a deterministic action layer. The Article 50(1) notice is mounted above the input.",
    evidence: ["client/src/pages/WorldGlobe.tsx", "client/src/lib/sovAsk.ts"] },
  { route: "/glossary", label: "Glossary", nature: "rule_based",
    mechanism: "Static guidance content with client-side navigation and filtering only. No model call exists in this surface's code.",
    evidence: ["client/src/pages/Glossary.tsx"] },
  { route: "/gods-eye", label: "Withdrawn cyber-scan prototype", nature: "rule_based",
    mechanism: "This route now renders a no-index evidence-review notice. It does not run a scan, call a model, fix findings, or issue signed evidence.",
    evidence: ["client/src/pages/ContentReviewNotice.tsx"] },
  { route: "/governance-graph", label: "GovGraph", nature: "ai_system",
    mechanism: "The query box sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/heatmap", label: "WatchdogMap", nature: "ai_system",
    mechanism: "The map Q&A sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/hive/:slug", label: "FrameworkHive", nature: "ai_system",
    mechanism: "The framework Q&A sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/humanoids-poc", label: "PocShowcase", nature: "ai_system",
    mechanism: "The showcase Q&A sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/dashboard?tab=home", label: "OsLauncher", nature: "ai_system",
    mechanism: "The launcher command box posts to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/regulator-atlas", label: "RegulatorAtlas", nature: "ai_system",
    mechanism: "The atlas Q&A sends your input to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/roi-calculator", label: "ROICalculator", nature: "rule_based",
    mechanism: "A deterministic instrument — fixed tables, templates or arithmetic over your input, so the same input gives the same output. No model call exists in this surface's code.",
    evidence: ["client/src/pages/ROICalculator.tsx"] },
  { route: "/scan", label: "Withdrawn cyber-scan prototype", nature: "rule_based",
    mechanism: "This route now renders a no-index evidence-review notice. It does not run a scan, call a model, fix findings, or issue signed evidence.",
    evidence: ["client/src/pages/ContentReviewNotice.tsx"] },
  ...
  { route: "/simulate", label: "CouncilSpace", nature: "ai_system",
    mechanism: "Scenario practice responses come from the configured /api/chat endpoint and are written by one model. They are not Council votes, verdicts, measurements, or signed evidence. The Art 50(1) notice is mounted before interaction.",
  ...
  { route: "/workbench", label: "Workbench", nature: "ai_system",
    mechanism: "The workbench asks the configured chat endpoint to produce a governance draft for the skill you pick. Its evidence state is reported separately and no Council review is implied. The Art 50(1) notice is registered here.",
  ...
  { route: "/try", label: "TryCouncil", nature: "ai_system",
    mechanism: "The first pass is local fixed-rule classification. The optional prompt sends the description to the configured /api/chat endpoint and returns one model response. It is not a Council vote, review, measurement, or signed result. The Article 50(1) notice is mounted above the input.",
  ...
  { route: "/hive", label: "FrameworkHive", nature: "ai_system",
    mechanism: "The hive list view mounts the same component as /hive/:slug, whose detail view asks the configured chat endpoint about the framework you open. Because this surface reaches a model endpoint it is registered ai_system; the Article 50(1) notice is mounted at the top of the list view. No Council review is implied.",
    evidence: ["client/src/pages/FrameworkHive.tsx", "client/src/lib/sovAsk.ts"] },
  ...
  { route: "/why-csoai", label: "WhyCSOAI", nature: "ai_system",
    mechanism: "The page mounts SovereignSpot, whose 'Ask your Council assistant' box sends your question through askSovereign to the configured /api/chat model endpoint, where a single model writes the answer; no Council review, vote, or signature is implied. The Article 50(1) notice is mounted at the top of the page, before the chat panel.",
