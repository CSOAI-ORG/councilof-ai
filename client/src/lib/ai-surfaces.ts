...
export const SURFACES: Surface[] = [
  ...
  { route: "/hive", label: "FrameworkHive", nature: "ai_system",
    mechanism: "The hive list view mounts the same component as /hive/:slug, whose detail view asks the live Sovereign (askSovereign) about the framework you open. Because this surface's code reaches the live chat endpoint it is registered ai_system; the Article 50(1) notice is mounted at the top of the list view.",
    evidence: ["client/src/pages/FrameworkHive.tsx", "client/src/lib/sovAsk.ts"] },
  ...
  { route: "/why-csoai", label: "WhyCSOAI", nature: "ai_system",
    mechanism: "The page mounts SovereignSpot, whose 'Ask the Sovereign' box sends your question through askSovereign to the live Sovereign chat endpoint (os.meok.ai/api/chat), where a model writes the answer. The Article 50(1) notice is mounted at the top of the page, before the chat panel.",
