...
export const SURFACES: Surface[] = [
  ...
  { route: "/demo", label: "DemoOS", nature: "ai_system",
    mechanism: "The guided demo answers questions through askSovereign, which sends your input to the live Council chat endpoint (councilof.ai/api/gspc), where a model writes the answer. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/hive/:slug", label: "FrameworkHive", nature: "ai_system",
    mechanism: "The framework Q&A uses askSovereign, which sends your input to the live Council chat endpoint (councilof.ai/api/gspc), where a model writes the answer. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/sov3", label: "Workbench", nature: "ai_system",
    mechanism: "The workbench asks the live Council assistant (askSovereign) to produce the governance artifact for the skill you pick. The Art 50(1) notice for this surface is registered here and being wired; until the component ships, this registry entry is the disclosure.",
  ...
  { route: "/hive", label: "FrameworkHive", nature: "ai_system",
    mechanism: "The hive list view mounts the same component as /hive/:slug, whose detail view asks the live Council assistant (askSovereign) about the framework you open. Because this surface's code reaches the live chat endpoint it is registered ai_system; the Article 50(1) notice is mounted at the top of the list view.",
    evidence: ["client/src/pages/FrameworkHive.tsx", "client/src/lib/sovAsk.ts"] },
