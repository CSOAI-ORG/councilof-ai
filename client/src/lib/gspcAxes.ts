// GSPC — 14-slot board (13 canonical + jail), as measured state.
//
...
export const AXES: Axis[] = [
  ...
  { axis: "jail", bench: "GoldBank-Detector", n: 71, macro_f1: 0, accuracy: 0.5915, unparsed_rate: 0,
    status: "MEASURED",
    colour: "#64748b", lng: -122.42, lat: 37.77, seat: "San Francisco", instrument: "Escape-attempt gold bank",
    task: "escape-attempt detection (71 gold cells) — smaller 7-model fleet",
    note: "Slot 14: separation UNTESTED. Best zero-FP detector recall 0.237 — published weakness, not hidden.", dataset: "pending publication" },
];
