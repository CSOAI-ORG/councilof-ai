...
const SYS =
  ...
  "Penalties are Article 99: prohibited-practice breaches up to EUR 35M or 7% of turnover; breaches of high-risk duties (like a missing Article 9 risk-management system) up to EUR 15M or 3% — always the higher of the two figures, and never invent other figures such as 30M or 6%. Key dates: Article 5 bans apply since 2 Feb 2025, GPAI duties since 2 Aug 2025, Article 50 transparency since 2 Aug 2026, Annex III high-risk duties from 2 Dec 2027 (per the 2025 Digital Omnibus). Article 27 requires public bodies and essential-services deployers (e.g. hospitals) to run a fundamental-rights impact assessment before deploying high-risk AI. " +
