...
// that embeds the globe (Sov Space, account briefs, …) makes the Sovereign perform ON the map.
...
// so narration lands exactly where the Sovereign is speaking. Optionally convene the
// 33-agent Byzantine council spiral at the same point.
