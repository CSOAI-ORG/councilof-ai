...
export const REGIONS: Record<string, RegionProfile> = {
  EU: { code: "EU", label: "European Union", frameworks: ["EU AI Act", "GDPR", "DORA", "NIS2", "CRA"], note: "The EU AI Act is the binding regime — GPAI + Article 50 transparency duties apply from 2 Aug 2026; high-risk obligations from 2 Dec 2027 (per the 2025 Digital Omnibus).", globe: [9.0, 50.5] },
