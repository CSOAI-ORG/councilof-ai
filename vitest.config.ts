...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [...defaultExclude, '**/.git-wt-*/**', 'docs/**/*.test.mjs', 'capabilities/**/*.test.mjs', 'mcp/gspc-server/wired-tools.test.mjs', 'e2e/**', '**/e2e/**', '**/worktrees/**', 'packages/**', 'council-os/planned-ready.lock.test.mjs'],
  },
});
