...
export const metadata: Metadata = {
  title: "AI Safety Testing Methodology | CSOAI Guide",
  description: "Comprehensive guide to AI safety testing. Learn red teaming, adversarial testing, robustness evaluation, and security assessment methodologies for AI systems.",
  alternates: { canonical: "/guide-safety-testing" },
  openGraph: {
    title: "AI Safety Testing Methodology",
    description: "Complete guide to designing and executing comprehensive AI safety testing programs.",
    type: "article",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "AI Safety Testing Methodology", item: "https://csoai.org/guide-safety-testing" },
  ],
};

export default function GuideSafetyTestingPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{ __html: `<section class="hero-section">\n            <div class="hero-content">\n                <div class="hero-text">\n                    <h1>AI Safety Testing Methodology</h1>\n                    <p>Comprehensive safety testing is critical for AI governance and certification. Learn red teaming, adversarial testing, robustness evaluation, and systematic security assessment methodologies for AI systems.</p>\n                    <a href="#steps" class="btn">Start Guide</a>\n                </div>\n                <div class="hero-svg">\n                    <svg viewBox="0 0 400 350" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 20px 40px rgba(212, 168, 67, 0.2));">\n                        <!-- Test stages -->\n                        <g opacity="0.8">\n                            <rect x="60" y="100" width="80" height="80" fill="none" stroke="#D4A843" stroke-width="2" rx="8"/>\n                            <rect x="160" y="100" width="80" height="80" fill="none" stroke="#D4A843" stroke-width="2" rx="8"/>\n                            <rect x="260" y="100" width="80" height="80" fill="none" stroke="#D4A843" stroke-width="2" rx="8"/>\n                        </g>\n                        <!-- Arrow between stages -->\n                        <g stroke="#E8B76D" stroke-width="2" opacity="0.6" fill="none">\n                            <path d="M 140 140 L 160 140" marker-end="url(#arrowhead)"/>\n                            <path d="M 240 140 L 260 140" marker-end="url(#arrowhead)"/>\n                        </g>\n                        <!-- Labels -->\n                        <text x="100" y="225" font-size="12" fill="#D4A843" text-anchor="middle" font-weight="600">Test Plan</text>\n                        <text x="200" y="225" font-size="12" fill="#D4A843" text-anchor="middle" font-weight="600">Execution</text>\n                        <text x="300" y="225" font-size="12" fill="#D4A843" text-anchor="middle" font-weight="600">Analysis</text>\n                        <!-- Results indicators -->\n                        <g opacity="0.7">\n                            <circle cx="100" cy="150" r="8" fill="#4CAF50"/><text x="100" y="155" font-size="12" fill="#4CAF50" text-anchor="middle">✓</text>\n                            <circle cx="200" cy="150" r="8" fill="#FFC107"/><text x="200" y="155" font-size="12" fill="#1A1145" text-anchor="middle">!</text>\n                            <circle cx="300" cy="150" r="8" fill="#F44336"/><text x="300" y="155" font-size="12" fill="#FFF" text-anchor="middle">⚠</text>\n                        </g>\n                        <!-- Testing pyramid -->\n                        <g opacity="0.6">\n                            <polygon points="200,280 150,310 250,310" fill="none" stroke="#D4A843" stroke-width="1.5"/>\n                            <text x="200" y="300" font-size="10" fill="#D4A843" text-anchor="middle">Test Results</text>\n                        </g>\n                    </svg>\n                </div>\n            </div>\n        </section>\n<div class="breadcrumbs">\n            <a href="/">Home</a> <span>/</span> <a href="/guides">Guides</a> <span>/</span> <span>Safety Testing</span>\n        </div>\n<div class="guide-container" id="steps">\n            <div class="guide-content">\n\n                <div class="step">\n                    <div class="step-number">1</div>\n<button class="back-to-top" id="backToTop" title="Back to top"></button>` }}
      />
    </div>
  );
}
