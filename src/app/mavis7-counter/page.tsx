...
export const metadata: Metadata = {
  title: "Mavis7 Counter — CSOAI",
  description: "CSOAI mavis7-counter page. The AI governance platform.",
};

export default function Mavis7CounterPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-4">Mavis7 Counter</h1>
