...
export const metadata: Metadata = {
  title: "AI Audit Checklist | CSOAI Guide",
  description: "Comprehensive AI audit checklist covering pre-audit preparation, documentation review, technical assessment, ethical evaluation, and reporting.",
  alternates: { canonical: "/guide-audit-checklist" },
  openGraph: {
    title: "AI Audit Checklist",
    description: "Complete checklist for preparing and conducting AI system audits.",
    type: "article",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "AI Audit Checklist", item: "https://csoai.org/guide-audit-checklist" },
  ],
};

export default function GuideAuditChecklistPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{ __html: `<section class="hero-section">\n            <div class="hero-content">\n                <div class="hero-text">\n                    <h1>AI Audit Checklist</h1>\n                    <p>Prepare your organization for successful AI audits with this comprehensive checklist. Cover documentation, technical review, ethical assessment, and regulatory compliance in one place.</p>\n                    <a href="#steps" class="btn">Start Guide</a>\n                </div>\n                <div class="hero-svg">\n                    <svg viewBox="0 0 400 350" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 20px 40px rgba(212, 168, 67, 0.2));">\n                        <!-- Checklist -->\n                        <g opacity="0.8">\n                            <rect x="80" y="60" width="240" height="260" fill="none" stroke="#D4A843" stroke-width="2" rx="8"/>\n                            <line x1="80" y1="100" x2="320" y2="100" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                            <line x1="80" y1="140" x2="320" y2="140" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                            <line x1="80" y1="180" x2="320" y2="180" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                            <line x1="80" y1="220" x2="320" y2="220" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                            <line x1="80" y1="260" x2="320" y2="260" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                        </g>\n                        <!-- Checkmarks -->\n                        <g opacity="0.9">\n                            <text x="105" y="130" font-size="20" fill="#4CAF50">✓</text>\n                            <text x="105" y="170" font-size="20" fill="#4CAF50">✓</text>\n                            <text x="105" y="210" font-size="20" fill="#D4A843">◐</text>\n                            <text x="105" y="250" font-size="20" fill="#F44336">✗</text>\n                            <text x="105" y="290" font-size="20" fill="#4CAF50">✓</text>\n                        </g>\n                    </svg>\n                </div>\n            </div>\n        </section>\n<div class="breadcrumbs">\n            <a href="/">Home</a> <span>/</span> <a href="/guides">Guides</a> <span>/</span> <span>Audit Checklist</span>\n        </div>\n<div class="guide-container" id="steps">\n            <div class="guide-content">\n\n                <div class="step">\n                    <div class="step-number">1</div>\n<button class="back-to-top" id="backToTop" title="Back to top"></button>` }}
      />
    </div>
  );
}
