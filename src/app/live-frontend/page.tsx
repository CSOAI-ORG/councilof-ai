...
export const metadata: Metadata = {
  title: "Live Frontend — CSOAI",
  description: "CSOAI live-frontend page. The AI governance platform.",
};

export default function LiveFrontendPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-4">Live Frontend</h1>
