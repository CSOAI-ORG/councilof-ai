      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              <a href="/frameworks/eu-ai-act" className="block hover:text-foreground">EU AI Act</a>
              <a href="/frameworks/nist-ai-rmf" className="block hover:text-foreground">NIST RMF</a>
              <a href="/frameworks/iso-42001" className="block hover:text-foreground">ISO 42001</a>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              ...
              <a href="https://care.csoai.org" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground">CareShield.ai ↗</a>
              <a href="https://wowmcp.ai" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground">WoWMCP.ai ↗</a>
            </div>
          </div>
          <div>
            <h4 className="text-sm font-semibold mb-3">Industries</h4>
            <div className="space-y-2 text-xs text-muted-foreground">
              <a href="https://grabhire.ai" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground">GrabHire.ai ↗</a>
              <a href="https://planthire.ai" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground">PlantHire.ai ↗</a>
