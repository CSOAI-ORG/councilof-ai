...
export const metadata: Metadata = {
  title: "Iok Farm — CSOAI",
  description: "CSOAI iok-farm page. The AI governance platform.",
};

export default function IokFarmPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-4">Iok Farm</h1>
