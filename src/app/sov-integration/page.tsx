...
export const metadata: Metadata = {
  title: "Sov Integration — CSOAI",
  description: "CSOAI sov-integration page. The AI governance platform.",
};

export default function SovIntegrationPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-4">Sov Integration</h1>
