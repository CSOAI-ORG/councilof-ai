...
export const metadata: Metadata = {
  title: "How to Build an AI Risk Register | CSOAI Guide",
  description: "Complete guide to building an AI risk register. Learn risk identification, assessment, prioritization, mitigation strategies, and continuous monitoring approaches.",
  alternates: { canonical: "/guide-risk-register" },
  openGraph: {
    title: "How to Build an AI Risk Register",
    description: "Step-by-step guide to systematic AI risk identification and management.",
    type: "article",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "How to Build an AI Risk Register", item: "https://csoai.org/guide-risk-register" },
  ],
};

export default function GuideRiskRegisterPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{ __html: `<section class="hero-section">\n            <div class="hero-content">\n                <div class="hero-text">\n                    <h1>How to Build an AI Risk Register</h1>\n                    <p>A comprehensive AI risk register is foundational for governance and compliance. This guide shows you how to systematically identify, assess, prioritize, and monitor AI risks across your organization.</p>\n                    <a href="#steps" class="btn">Start Guide</a>\n                </div>\n                <div class="hero-svg">\n                    <svg viewBox="0 0 400 350" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 20px 40px rgba(212, 168, 67, 0.2));">\n                        <!-- Risk matrix -->\n                        <g opacity="0.3">\n                            <rect x="80" y="80" width="240" height="240" fill="none" stroke="#D4A843" stroke-width="2"/>\n                            <line x1="200" y1="80" x2="200" y2="320" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                            <line x1="80" y1="200" x2="320" y2="200" stroke="#D4A843" stroke-width="1" opacity="0.5"/>\n                        </g>\n                        <!-- Risk zones -->\n                        <rect x="80" y="80" width="120" height="120" fill="#4CAF50" opacity="0.15"/>\n                        <rect x="200" y="80" width="120" height="120" fill="#FFC107" opacity="0.15"/>\n                        <rect x="80" y="200" width="120" height="120" fill="#FFC107" opacity="0.15"/>\n                        <rect x="200" y="200" width="120" height="120" fill="#F44336" opacity="0.15"/>\n                        <!-- Risk points -->\n                        <circle cx="140" cy="130" r="6" fill="#4CAF50"/>\n                        <circle cx="240" cy="160" r="6" fill="#FFC107"/>\n                        <circle cx="110" cy="250" r="6" fill="#FFC107"/>\n                        <circle cx="260" cy="280" r="6" fill="#F44336"/>\n                        <!-- Axis labels -->\n                        <text x="210" y="340" font-size="12" fill="#D4A843" text-anchor="middle">Impact →</text>\n                        <text x="50" y="200" font-size="12" fill="#D4A843" text-anchor="middle" transform="rotate(-90 50 200)">Probability →</text>\n                    </svg>\n                </div>\n            </div>\n        </section>\n<div class="breadcrumbs">\n            <a href="/">Home</a> <span>/</span> <a href="/guides">Guides</a> <span>/</span> <span>Risk Register</span>\n        </div>\n<div class="guide-container" id="steps">\n            <div class="guide-content">\n\n                <div class="step">\n                    <div class="step-number">1</div>\n<button class="back-to-top" id="backToTop" title="Back to top"></button>` }}
      />
    </div>
  );
}
