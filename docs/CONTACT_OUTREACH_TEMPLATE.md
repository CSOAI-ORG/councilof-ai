# Contact outreach template (NEXT_300 #375–390)

Public-artifact-only outreach. **No cold email harvest in-repo.** Sixteen slots for human operators:

| Slot | Contact class | Public artifact to cite | Ask |
|------|---------------|-------------------------|-----|
| 1–4 | XRPL issuers | XRPScan issuer pages | confirm public_id for Stage 2 testnet pointer |
