...
**LIVE STATE (after #1077, 2026-09-01 — supersedes 15·7):**
- GET /api/gspc → **22 axis · 22 measured · 0 unmeasured · 893 items**. `totals.public_count` is the live sentence.
...
|---|---|---|---|
| Public quotable board | 22/22 | GET /api/gspc → totals.public_count | 22 axes, 22 measured, 0 unmeasured (after #1077). NEVER a typed integer — cite the live sentence. |
...
2. The only count typed in COPY = the live public_count sentence ("22 axis · 22 measured"); every other
...
- ADR-001 + signed board `gspc-board-22axis-2026`: historical 22·15·7; LIVE after #1077 is 22·22·0
