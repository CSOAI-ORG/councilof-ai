...
> Signed Attestations target-list corpus `wf-67a7e7b4…`) with Council doctrine
...
**Out of Stage 1 (unchanged):** CobolBridge SKU, XRPL bond *issuance*, invented AUM/revenue as MEASURED, mainnet RWA attach, insurer/Big Four paid pilots before reference-layer proof.
...
- Compass: permissionless XRPL Credential/Memo + EAS ranking (`wf-98f085ad-…`); Signed Attestations target-list corpus (`wf-67a7e7b4-…`, Aug 2026)  
