...
| 3 | XRPL issuer | [Ripple / Aviva coverage](https://ripple.com/) (issuer TBD on XRPScan · #166) | confirm issuer when on-ledger | coverage ✅ · issuer TBD · send ☐ |
...
| 8 | EVM token | [Moody's / Zeconomy coverage](https://www.moodys.com/) (`public_id` null · CAUTION) | caution play — issuer TBD | coverage ✅ · issuer TBD · send ☐ |
