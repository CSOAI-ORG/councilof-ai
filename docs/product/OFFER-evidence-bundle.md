...
> One page. Derived from live probes (https://councilof.ai); full description: docs/product/evidence-bundle.md.
> Prices are quoted at the 402 door — never here.

| fact | value |
|---|---|
| free preview | HTTP 200 · 11497 B |
| paid door | HTTP 402 (settle unlocks) |
| deliverable | NON-EMPTY PREVIEW (see doc) |

## What you receive
The artefact described in docs/product/evidence-bundle.md: signed cards, assembled server-side from
