# Offer — receipts-batch

> One page. Derived from live probes (https://councilof.ai); full description: docs/product/receipts-batch.md.
> Prices are quoted at the 402 door — never here.

| fact | value |
|---|---|
| free preview | HTTP 200 · 2047 B |
| paid door | HTTP 402 (settle unlocks) |
| deliverable | DELIVERABLE — free preview answers with real bytes. Advertised. |

## What you receive
The artefact described in docs/product/receipts-batch.md: signed cards, assembled server-side from
