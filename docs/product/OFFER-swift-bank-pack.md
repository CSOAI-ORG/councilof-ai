# Offer — swift-bank-pack

> One page. Derived from live probes (https://councilof.ai); full description: docs/product/swift-bank-pack.md.
> Prices are quoted at the 402 door — never here.

| fact | value |
|---|---|
| free preview | HTTP 200 · 13661 B |
