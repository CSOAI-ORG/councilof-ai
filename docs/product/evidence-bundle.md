...
`evidence-bundle` — derived from live endpoints on 2026-09-06T06:00:18Z.
...
`https://councilof.ai/api/evidence-bundle?obligation=article-50` — status **200**, **12992 bytes**, `sha256 ff5d2d84a644d41c…`
