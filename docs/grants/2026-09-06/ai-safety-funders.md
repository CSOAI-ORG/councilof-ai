# AI-safety funders open in September 2026 — TAIF first, then Manifund

Source: Manifund "AI Safety Funder Bulletin", last updated 1 Sep 2026
(https://manifund.org/ais-funder-bulletin) — SFF, Lightcone Commons and Coefficient Giving are listed there too (fit 1 for us). Fund pages read 06 Sep. Money type: USD grants.

| Funder | Open? | Size | Door | Our fit |
|---|---|---|---|---|
...
**What the grant funds** — public-good work only: (1) public-root v2 (RFC 6962 domain separation) with
conformance vectors; (2) a second, independent verifier; (3) key-rotation rehearsal and external review of the
signing path; (4) re-running the 14 behavioural banks on the current frontier fleet. Not the site, doors or our models.
**Why this reduces AI risk** — modestly: a public, tamper-evident record of model behaviour lets third
parties check vendor claims without trusting the publisher. Evaluation infrastructure, not alignment research.
**Budget** — 12 months, sole maintainer; hours + compute (costed in the 05 Sep STF pack) + external review;
ask in the $30–60k band.
**Team** — Nicholas Templeman, ORCID 0009-0001-3869-1068, sole maintainer; CSOAI Ltd, UK 16939677.
**Other funding** — none received; STF and NLnet applications in preparation (disclose).
