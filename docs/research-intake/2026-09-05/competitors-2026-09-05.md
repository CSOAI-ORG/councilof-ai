...
| **UNMEASURED as a first-class published state** | `/api/hub-cards` → 0 of 885 cells say UNMEASURED(live as_of 2026-09-07T04:16:35.252Z; prior 70 of 761 STALE) | Leaderboards report what they measured and stay silent on the rest |
