...
| Risk / estate | EstateAudit + EAT playbook | `/estate`, `/competitors` (52 records) |
...
- [ ] Explicit tool-name → card component registry in Lobby
...
- CobolBridge / XRPL bond issuance as Stage-1 scope
