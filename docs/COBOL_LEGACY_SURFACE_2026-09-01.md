...
**Kill** any CSGA-competitor framing (prior Measure memory that called it a competitor is void).
...
Grammar: `docs/CARD_V0_EVIDENCE_GRAMMAR_2026-09-01.md` §4b.  
Schema enum includes `cobol.legacy`.
