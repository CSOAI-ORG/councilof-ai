#!/usr/bin/env python3
"""Produce one card-v0 per x402 settlement from the census jsonl.
...
UNMEASURED_AT_N1 = [
    "reliability: n=1, a single purchase cannot establish whether this host delivers repeatedly",
    "availability: not observed over time; one moment only",
...
def main() -> int:
    ...
    ap.add_argument("--out", default="harness/x402-census/cards")
