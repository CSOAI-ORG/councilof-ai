...
|---|---|---|---|
| the 313 cards under `/signed/cards/` | `#card-attestation-1` | `sort_keys=True, separators=(',',':')`, **`ensure_ascii=True`**, CPython float `repr` (integral floats render `0.0`) | the raw UTF-8 preimage bytes of `body` |
