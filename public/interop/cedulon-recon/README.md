...
| `card-unsigned.consumer.json` | Harness consumer output (unsigned) |
...
See [`HARNESS.md`](./HARNESS.md) and `scripts/interop/cedulon_recon_consumer.py` (bank → unsigned `cedulon.recon`). Measure dept: `~/.grokbot/harness/run.sh measure`.
