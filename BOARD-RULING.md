...
- **GET /api/gspc** → 22 axis · 22 measured. `totals.public_count` is the live sentence.
...
- **GET /api/gspc** → 22 axis · 15 measured · 893 items. (superseded; live is 22·22 after #1077)
